...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-async.util.map">async.util.map</a>
...
<main role="main" aria-label="Page node_modules/async.util.map/README.md">

<h1 id="label-async.util.map">async.util.map<span><a href="#label-async.util.map">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p><img
src="https://img.shields.io/github/tag/async-js/async.util.map.svg?style=flat-square">
<a href="https://david-dm.org/async-js/async.util.map"><img
src="http://img.shields.io/david/async-js/async.util.map.svg?style=flat-square"></a>
<a
href="https://david-dm.org/async-js/async.util.map#info=devDependencies"><img
src="http://img.shields.io/david/dev/async-js/async.util.map.svg?style=flat-square"></a>
<a href="https://www.npmjs.org/package/async.util.map"><img
src="http://img.shields.io/npm/dm/async.util.map.svg?style=flat-square"></a>
<a href="https://paypal.me/kikobeats"><img
src="https://img.shields.io/badge/donate-paypal-blue.svg?style=flat-square"></a></p>

<blockquote>
<p>async map helper method as module.</p>
</blockquote>
