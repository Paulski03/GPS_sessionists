...
<main role="main" aria-label="Page node_modules/async.util.setimmediate/index.js">

<p>&#39;use strict&#39;;</p>

<p>var _setImmediate = typeof setImmediate === &#39;function&#39; &amp;&amp;
setImmediate; var fallback = function(fn) {</p>

<pre class="ruby"><span class="ruby-identifier">setTimeout</span>(<span class="ruby-identifier">fn</span>, <span class="ruby-value">0</span>);
</pre>

<p>};</p>

<p>module.exports = function setImmediate(fn) {</p>

<pre>// not a direct alias for IE10 compatibility
return (_setImmediate || fallback)(fn);</pre>
