...
<main role="main" aria-label="Page node_modules/async.queue/index.js">

<p>&#39;use strict&#39;;</p>

<p>var queue = require(&#39;async.util.queue&#39;);</p>

<p>module.exports = function (worker, concurrency) {</p>

<pre>return queue(function (items, cb) {
    worker(items[0], cb);
}, concurrency, 1);</pre>
