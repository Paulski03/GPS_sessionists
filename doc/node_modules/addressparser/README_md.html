...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-addressparser">addressparser</a>
...
<main role="main" aria-label="Page node_modules/addressparser/README.md">

<h1 id="label-addressparser">addressparser<span><a href="#label-addressparser">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>Parse e-mail address fields. Input can be a single address
(<code>&quot;andris@kreata.ee&quot;</code>), a formatted address
(<code>&quot;Andris Reinman &lt;andris@kreata.ee&gt;&quot;</code>), comma
separated list of addresses (<code>&quot;andris@kreata.ee,
andris.reinman@kreata.ee&quot;</code>), an address group
(<code>&quot;disclosed-recipients:andris@kreata.ee;&quot;</code>) or a mix
of all the formats.</p>

<p>In addition to comma the semicolon is treated as the list delimiter as well
(except when used in the group syntax), so a value
<code>&quot;andris@kreata.ee; andris.reinman@kreata.ee&quot;</code> is
identical to <code>&quot;andris@kreata.ee,
andris.reinman@kreata.ee&quot;</code>.</p>

<h2 id="label-Installation">Installation<span><a href="#label-Installation">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Install with npm</p>

<pre class="ruby"><span class="ruby-identifier">npm</span> <span class="ruby-identifier">install</span> <span class="ruby-identifier">addressparser</span>
</pre>
...
<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">addressparser</span> = <span class="ruby-identifier">require</span>(<span class="ruby-string">&#39;addressparser&#39;</span>);
</pre>

<p>Parse some address strings with <code>addressparser(field)</code></p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">addresses</span> = <span class="ruby-identifier">addressparser</span>(<span class="ruby-string">&#39;andris &lt;andris@tr.ee&gt;&#39;</span>);
<span class="ruby-identifier">console</span>.<span class="ruby-identifier">log</span>(<span class="ruby-identifier">addresses</span>); <span class="ruby-regexp">//</span> [{<span class="ruby-identifier">name</span><span class="ruby-operator">:</span> <span class="ruby-string">&quot;andris&quot;</span>, <span class="ruby-identifier">address</span>:<span class="ruby-string">&quot;andris@tr.ee&quot;</span>}]
</pre>

<p>And when using groups</p>

<pre class="ruby"><span class="ruby-identifier">addressparser</span>(<span class="ruby-string">&#39;Composers:&quot;Bach, Sebastian&quot; &lt;sebu@example.com&gt;, mozart@example.com (Mozzie);&#39;</span>);
</pre>
...
<pre class="ruby">[
    {
        <span class="ruby-identifier">name</span><span class="ruby-operator">:</span> <span class="ruby-string">&quot;Composers&quot;</span>,
        <span class="ruby-identifier">group</span><span class="ruby-operator">:</span> [
            {
                <span class="ruby-identifier">address</span><span class="ruby-operator">:</span> <span class="ruby-string">&quot;sebu@example.com&quot;</span>,
                <span class="ruby-identifier">name</span><span class="ruby-operator">:</span> <span class="ruby-string">&quot;Bach, Sebastian&quot;</span>
            },
            {
                <span class="ruby-identifier">address</span><span class="ruby-operator">:</span> <span class="ruby-string">&quot;mozart@example.com&quot;</span>,
                <span class="ruby-identifier">name</span><span class="ruby-operator">:</span> <span class="ruby-string">&quot;Mozzie&quot;</span>
            }
        ]
    }
]
...
<blockquote>
<p>Be prepared though that groups might be nested.</p>
</blockquote>

<h2 id="label-Notes">Notes<span><a href="#label-Notes">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>This module does not decode any mime-word or punycode encoded strings, it
is only a basic parser for parsing the base data, you need to decode the
encoded parts later by yourself</p>
