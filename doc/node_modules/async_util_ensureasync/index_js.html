...
<main role="main" aria-label="Page node_modules/async.util.ensureasync/index.js">

<p>&#39;use strict&#39;; var setImmediate =
require(&#39;async.util.setimmediate&#39;); var restParam =
require(&#39;async.util.restparam&#39;);</p>

<p>module.exports = function(fn) {</p>

<pre>return restParam(function(args) {
