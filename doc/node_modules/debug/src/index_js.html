...
<main role="main" aria-label="Page node_modules/debug/src/index.js">

<pre>Detect Electron renderer process, which is node, but we should
treat as a browser.</pre>

<p>if (typeof process !== &#39;undefined&#39; &amp;&amp; process.type ===
&#39;renderer&#39;) {</p>

<pre>module.exports = require(&#39;./browser.js&#39;);</pre>

<p>} else {</p>

<pre>module.exports = require(&#39;./node.js&#39;);</pre>
