...
<title>Makefile - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/debug/Makefile">

<p># get <a href="Makefile.html">Makefile</a> directory name: <a
href="http://stackoverflow.com/a/5982798/376773">stackoverflow.com/a/5982798/376773</a>
THIS_MAKEFILE_PATH:=$(word $(words $(MAKEFILE_LIST)),$(MAKEFILE_LIST))
THIS_DIR:=$(shell cd $(dir $(THIS_MAKEFILE_PATH));pwd)</p>

<p># BIN directory BIN := $(THIS_DIR)/node_modules/.bin</p>

<p># Path PATH := node_modules/.bin:$(PATH) SHELL := /bin/bash</p>

<p># applications NODE ?= $(shell which node) YARN ?= $(shell which yarn) PKG
?= $(if $(YARN),$(YARN),$(NODE) $(shell which npm)) BROWSERIFY ?= $(NODE)
$(BIN)/browserify</p>
...
<p>node_modules: <a href="../../package_json.html">package.json</a></p>

<pre>@NODE_ENV= $(PKG) install
@touch node_modules</pre>

<p>lint: .FORCE</p>

<pre class="ruby"><span class="ruby-identifier">eslint</span> <span class="ruby-identifier">browser</span>.<span class="ruby-identifier">js</span> <span class="ruby-identifier">debug</span>.<span class="ruby-identifier">js</span> <span class="ruby-identifier">index</span>.<span class="ruby-identifier">js</span> <span class="ruby-identifier">node</span>.<span class="ruby-identifier">js</span>
</pre>

<p>test-node: .FORCE</p>

<pre>istanbul cover node_modules/mocha/bin/_mocha -- test/**.js</pre>

<p>test-browser: .FORCE</p>
...
<pre class="ruby"><span class="ruby-identifier">concurrently</span>          <span class="ruby-string">&quot;make test-node&quot;</span>          <span class="ruby-string">&quot;make test-browser&quot;</span>
</pre>

<p>coveralls:</p>

<pre>cat ./coverage/lcov.info | ./node_modules/coveralls/bin/coveralls.js</pre>

<p>.PHONY: all install clean distclean</p>
</main>
