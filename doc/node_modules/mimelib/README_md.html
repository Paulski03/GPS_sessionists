...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-THIS+MODULE+IS+DEPRECATED">THIS MODULE IS DEPRECATED</a>
    <li><a href="#label-mimelib">mimelib</a>
    <li><a href="#label-Installation">Installation</a>
    <li><a href="#label-Usage">Usage</a>
    <li><a href="#label-Reference">Reference</a>
    <li><a href="#label-foldLine">foldLine</a>
    <li><a href="#label-encodeMimeWord">encodeMimeWord</a>
    <li><a href="#label-decodeMimeWord">decodeMimeWord</a>
    <li><a href="#label-encodeQuotedPrintable">encodeQuotedPrintable</a>
    <li><a href="#label-decodeQuotedPrintable">decodeQuotedPrintable</a>
    <li><a href="#label-encodeBase64">encodeBase64</a>
    <li><a href="#label-decodeBase64">decodeBase64</a>
    <li><a href="#label-parseHeaders">parseHeaders</a>
    <li><a href="#label-parseAddresses">parseAddresses</a>
    <li><a href="#label-parseMimeWords">parseMimeWords</a>
    <li><a href="#label-parseHeaderLine">parseHeaderLine</a>
    <li><a href="#label-contentTypes">contentTypes</a>
    <li><a href="#label-iconv+support">iconv support</a>
...
<main role="main" aria-label="Page node_modules/mimelib/README.md">

<h2 id="label-THIS+MODULE+IS+DEPRECATED">THIS MODULE IS DEPRECATED<span><a href="#label-THIS+MODULE+IS+DEPRECATED">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h1 id="label-mimelib">mimelib<span><a href="#label-mimelib">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p><em>mimelib</em> is a collection of useful functions to deal with
mime-encoded data.</p>

<h2 id="label-Installation">Installation<span><a href="#label-Installation">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Install with <em>npm</em></p>

<pre class="ruby"><span class="ruby-identifier">npm</span> <span class="ruby-identifier">install</span> <span class="ruby-identifier">mimelib</span>
</pre>

<h2 id="label-Usage">Usage<span><a href="#label-Usage">&para;</a> <a href="#top">&uarr;</a></span></h2>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">mimelib</span> = <span class="ruby-identifier">require</span>(<span class="ruby-string">&quot;mimelib&quot;</span>);
</pre>

<h2 id="label-Reference">Reference<span><a href="#label-Reference">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h3 id="label-foldLine">foldLine<span><a href="#label-foldLine">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Folds a long line according to the RFC 5322 <a
href="http://tools.ietf.org/html/rfc5322#section-2.1.1">tools.ietf.org/html/rfc5322#section-2.1.1</a></p>

<pre>mimelib.foldLine(str [, maxLength][, foldAnywhere][, afterSpace]) -&gt; String</pre>
<ul><li>
<p><code>str</code> (String): mime string that might need folding</p>
</li><li>
<p><code>maxLength</code> (Number): max length for a line, defaults to 78</p>
</li><li>
<p><code>foldAnywhere</code> (Boolean): can fold at any location (ie. in
base64)</p>
</li><li>
<p><code>afterSpace</code> (Boolean): If <code>true</code> fold after the
space</p>
</li></ul>

<p>For example:</p>

<pre>Content-Type: multipart/alternative; boundary=&quot;----zzzz----&quot;</pre>
...
<h3 id="label-encodeMimeWord">encodeMimeWord<span><a href="#label-encodeMimeWord">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Encodes a string into mime encoded word format <a
href="http://en.wikipedia.org/wiki/MIME#Encoded-Word">en.wikipedia.org/wiki/MIME#Encoded-Word</a>
(see also <code>decodeMimeWord</code>)</p>

<pre>mimelib.encodeMimeWord = function(str [, encoding][, charset])</pre>
<ul><li>
<p><code>str</code> (String): String to be encoded</p>
</li><li>
<p><code>encoding</code> (String): Encoding Q for quoted printable or B (def.)
for base64</p>
</li><li>
<p><code>charset</code> (String): Charset to be used</p>
</li></ul>

<p>For example:</p>

<pre class="ruby"><span class="ruby-constant">See</span> <span class="ruby-identifier">on</span> <span class="ruby-identifier">õhin</span> <span class="ruby-identifier">test</span>
</pre>

<p>Becomes with UTF-8 and Quoted-printable encoding</p>

<pre>=?UTF-8?Q?See_on_=C3=B5hin_test?=</pre>

<h3 id="label-decodeMimeWord">decodeMimeWord<span><a href="#label-decodeMimeWord">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Decodes a string from mime encoded word format (see also
<code>encodeMimeWord</code>)</p>

<pre>mimelib.decodeMimeWord(str) -&gt; String</pre>
<ul><li>
<p><code>str</code> (String): String to be decoded</p>
</li></ul>

<p>For example</p>

<pre class="ruby"><span class="ruby-identifier">mimelib</span>.<span class="ruby-identifier">decodeMimeWord</span>(<span class="ruby-string">&quot;=?UTF-8?Q?See_on_=C3=B5hin_test?=&quot;</span>);
</pre>
...
<h3 id="label-encodeQuotedPrintable">encodeQuotedPrintable<span><a href="#label-encodeQuotedPrintable">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Encodes a string into Quoted-printable format (see also
<code>decodeQuotedPrintable</code>)</p>

<pre>mimelib.encodeQuotedPrintable(str [, mimeWord][, charset]) -&gt; String</pre>
<ul><li>
<p><code>str</code> (String): String to be encoded into Quoted-printable</p>
</li><li>
<p><code>mimeWord</code> (Boolean): Deprecated, has no effect, ignore it</p>
</li><li>
<p><code>charset</code> (String): Destination charset, defaults to UTF-8</p>
</li></ul>

<h3 id="label-decodeQuotedPrintable">decodeQuotedPrintable<span><a href="#label-decodeQuotedPrintable">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Decodes a string from Quoted-printable format (see also
<code>encodeQuotedPrintable</code>)</p>

<pre>mimelib.decodeQuotedPrintable(str [, mimeWord][, charset]) -&gt; String</pre>
<ul><li>
<p><code>str</code> (String): String to be decoded</p>
</li><li>
<p><code>mimeWord</code> (Boolean): Deprecated, has no effect, ignore it</p>
</li><li>
<p><code>charset</code> (String): Charset to be used, defaults to UTF-8</p>
</li></ul>

<h3 id="label-encodeBase64">encodeBase64<span><a href="#label-encodeBase64">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Encodes a string into Base64 format. Base64 is mime-word safe (see also
<code>decodeBase64</code>)</p>

<pre>mimelib.encodeBase64(str [, charset]) -&gt; String</pre>
<ul><li>
<p><code>str</code> (String): String to be encoded into Base64</p>
</li><li>
<p><code>charset</code> (String): Destination charset, defaults to UTF-8</p>
</li></ul>

<h3 id="label-decodeBase64">decodeBase64<span><a href="#label-decodeBase64">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Decodes a string from Base64 format. Base64 is mime-word safe (see also
<code>encodeBase64</code>)</p>

<p>NB! Always returns UTF-8</p>

<pre>mimelib.decodeBase64(str) -&gt; String</pre>
<ul><li>
<p><code>str</code> (String): String to be decoded from Base64</p>
</li><li>
<p><code>charset</code> (String): Source charset, defaults to UTF-8</p>
</li></ul>

<h3 id="label-parseHeaders">parseHeaders<span><a href="#label-parseHeaders">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Parses header lines into an array of objects (see
<code>parseHeaderLine</code>)</p>

<pre>mimelib.parseHeaders(headers) -&gt; Array</pre>
<ul><li>
<p><code>headers</code> (String): header section of the e-mail</p>
</li></ul>

<p>Example:</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">headers</span> = [
    <span class="ruby-string">&quot;From: andris@node.ee&quot;</span>,
    <span class="ruby-string">&quot;To: juulius@node.ee&quot;</span>,
    <span class="ruby-string">&quot;To: juulius2@node.ee&quot;</span>,
    <span class="ruby-string">&quot;Content-type: text/html;&quot;</span>,
    <span class="ruby-string">&quot;    charset=utf-8&quot;</span>
    ].<span class="ruby-identifier">join</span>(<span class="ruby-string">&quot;\r\n&quot;</span>);
<span class="ruby-identifier">mimelib</span>.<span class="ruby-identifier">parseHeaders</span>(<span class="ruby-identifier">headers</span>);
</pre>

<p>Results in</p>

<pre class="ruby">{<span class="ruby-string">&quot;from&quot;</span><span class="ruby-operator">:</span> [ <span class="ruby-string">&#39;andris@node.ee&#39;</span> ],
 <span class="ruby-string">&quot;to&quot;</span><span class="ruby-operator">:</span> [ <span class="ruby-string">&#39;juulius@node.ee&#39;</span>, <span class="ruby-string">&#39;juulius2@node.ee&#39;</span> ],
 <span class="ruby-string">&quot;content-type&quot;</span><span class="ruby-operator">:</span> [ <span class="ruby-string">&#39;text/html;    charset=utf-8&#39;</span> ] }
</pre>

<h3 id="label-parseAddresses">parseAddresses<span><a href="#label-parseAddresses">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Parses names and addresses from a from, to, cc or bcc line</p>

<pre>mimelib.parseAddresses(addresses) -&gt; Array</pre>
<ul><li>
<p><code>addresses</code> (String): string with comma separated e-mail
addresses</p>
</li></ul>

<p>Example:</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">to</span> = <span class="ruby-string">&#39;&quot;Andris Reinman&quot; &lt;andris@node.ee&gt;, juulius@node.ee&#39;</span>
<span class="ruby-identifier">mimelib</span>.<span class="ruby-identifier">parseAddresses</span>(<span class="ruby-identifier">to</span>);
</pre>

<p>Results in</p>

<pre class="ruby">[{ <span class="ruby-identifier">address</span><span class="ruby-operator">:</span> <span class="ruby-string">&#39;andris@node.ee&#39;</span>, <span class="ruby-identifier">name</span><span class="ruby-operator">:</span> <span class="ruby-string">&#39;Andris Reinman&#39;</span> },
 { <span class="ruby-identifier">address</span><span class="ruby-operator">:</span> <span class="ruby-string">&#39;juulius@node.ee&#39;</span>, <span class="ruby-identifier">name</span><span class="ruby-operator">:</span> <span class="ruby-keyword">false</span> }]
</pre>

<h3 id="label-parseMimeWords">parseMimeWords<span><a href="#label-parseMimeWords">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Parses mime-words into UTF-8 strings</p>

<pre>mimelib.parseMimeWords(str) -&gt; String</pre>
<ul><li>
<p><code>str</code> (String): string to be parsed, if includes any mime words,
then these are converted to UTF-8 strings</p>
</li></ul>

<p>For example:</p>

<pre class="ruby"><span class="ruby-identifier">mimelib</span>.<span class="ruby-identifier">parseMimeWords</span>(<span class="ruby-string">&quot;Hello: =?UTF-8?Q?See_on_=C3=B5hin_test?=&quot;</span>);
</pre>

<p>Results in</p>

<pre class="ruby"><span class="ruby-string">&quot;Hello: See on õhin test&quot;</span>
</pre>

<h3 id="label-parseHeaderLine">parseHeaderLine<span><a href="#label-parseHeaderLine">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Parses a header line to search for additional parameters.</p>

<pre>mimelib.parseHeaderLine(line) -&gt; Object</pre>
<ul><li>
<p><code>line</code> (String): a line from a message headers</p>
</li></ul>

<p>For example:</p>

<pre>mimelib.parseHeaderLine(&quot;text/plain; charset=utf-8&quot;)imelib</pre>

<p>Results in</p>

<pre class="ruby">{<span class="ruby-string">&quot;defaultValue&quot;</span><span class="ruby-operator">:</span> <span class="ruby-string">&#39;text/plain&#39;</span>,
 <span class="ruby-string">&quot;charset&quot;</span><span class="ruby-operator">:</span> <span class="ruby-string">&#39;utf-8&#39;</span> }
</pre>

<h3 id="label-contentTypes">contentTypes<span><a href="#label-contentTypes">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p><strong>NB! this feature is deprecated</strong>, use <a
href="https://github.com/broofa/node-mime">mime</a> module instead to
detect content types and extensions</p>

<p><code>mimelib.contentTypes</code> is an object to provide content type
strings for common file extensions</p>

<pre>mimelib.contentTypes[&quot;xls&quot;]; // &quot;application/vnd.ms-excel&quot;</pre>

<h2 id="label-iconv+support">iconv support<span><a href="#label-iconv+support">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>By default only iconv-lite support is bundled. If you need node-iconv
support, you need to add it as an additional dependency for your project:</p>
...
<p>mimelib is licensed under the <a
href="http://ec.europa.eu/idabc/eupl.html">European Union Public License
1.1</a>.</p>
</main>
