...
<main role="main" aria-label="Page node_modules/sendgrid-rest/README.md">

<p><a href="https://travis-ci.org/sendgrid/nodejs-http-client"><img
src="https://travis-ci.org/sendgrid/nodejs-http-client.svg?branch=master"></a></p>

<p><strong>Quickly and easily access any RESTful or RESTful-like API.</strong></p>

<p>If you are looking for the SendGrid API client library, please see <a
href="https://github.com/sendgrid/sendgrid-nodejs">this repo</a>.</p>
...
href="https://github.com/sendgrid/nodejs-http-client/blob/master/CHANGELOG.md">CHANGELOG</a>.</p>
...
<pre class="ruby"><span class="ruby-identifier">npm</span> <span class="ruby-identifier">install</span> <span class="ruby-identifier">sendgrid</span><span class="ruby-operator">-</span><span class="ruby-identifier">rest</span>
</pre>

<h1 id="label-Quick+Start">Quick Start<span><a href="#label-Quick+Start">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p><code>GET /your/api/{param}/call</code></p>

<pre>var Client = require(&#39;sendgrid-rest&#39;).Client
...
<p><code>POST /your/api/{param}/call</code> with headers, query parameters and
a request body.</p>
...
<p>Following is an example using SendGrid. You can get your free account <a
href="https://sendgrid.com/free?source=nodejs-http-client">here</a>.</p>

<p>First, update your environment with your <a
href="https://app.sendgrid.com/settings/api_keys">SENDGRID_API_KEY</a>.</p>
...
<p>Here is the <a
href="https://github.com/sendgrid/nodejs-http-client/blob/master/examples/example.js">full
working code</a>.</p>

<p>To run the example:</p>

<pre class="ruby"><span class="ruby-identifier">node</span> <span class="ruby-identifier">examples</span><span class="ruby-operator">/</span><span class="ruby-identifier">example</span>
</pre>
...
<p>We encourage contribution to our libraries, please see our <a
href="https://github.com/sendgrid/nodejs-http-client/blob/master/CONTRIBUTING.md">CONTRIBUTING</a>
guide for details.</p>
<ul><li>
<p><a
href="https://github.com/sendgrid/nodejs-http-client/blob/master/CONTRIBUTING.md#feature_request">Feature
Request</a></p>
</li><li>
<p><a
href="https://github.com/sendgrid/nodejs-http-client/blob/master/CONTRIBUTING.md#submit_a_bug_report">Bug
Reports</a></p>
</li><li>
<p><a
href="https://github.com/sendgrid/nodejs-http-client/blob/master/CONTRIBUTING.md#improvements_to_the_codebase">Improvements
to the Codebase</a></p>
</li></ul>

<h1 id="label-About">About<span><a href="#label-About">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>nodejs-http-client is guided and supported by the SendGrid <a
href="mailto:dx@sendgrid.com">Developer Experience Team</a>.</p>

<p>nodejs-http-client is maintained and funded by SendGrid, Inc. The names and
logos for nodejs-http-client are trademarks of SendGrid, Inc.</p>
