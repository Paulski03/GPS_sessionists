...
<title>client.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/sendgrid-rest/lib/client.js">

<p>&#39;use strict&#39;</p>

<p>var https = require(&#39;https&#39;) var http = require(&#39;http&#39;) var
queryString = require(&#39;querystring&#39;)</p>

<p>// request holds the request to an API Call var request = {</p>
...
port: &#39;&#39;     // set the port for http calls</pre>

<p>}</p>

<p>var emptyRequest = JSON.parse(JSON.stringify(request))</p>

<p>// response holds the response from an API call, use this as an initializer
// like so: JSON.parse(JSON.stringify(response)) var response = {</p>
...
<p>// Client allows for quick and easy access any REST or REST-like API.
function Client (globalRequest) {</p>

<pre>var emptyResponse = JSON.parse(JSON.stringify(response))
var body = &#39;&#39;
