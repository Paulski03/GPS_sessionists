...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-CLAs+and+CCLAs">CLAs and CCLAs</a>
    <li><a href="#label-Feature+Request">Feature Request</a>
    <li><a href="#label-Submit+a+Bug+Report">Submit a Bug Report</a>
    <li><a href="#label-Please+use+our+Bug+Report+Template">Please use our Bug Report Template</a>
    <li><a href="#label-Improvements+to+the+Codebase">Improvements to the Codebase</a>
    <li><a href="#label-Development+Environment">Development Environment</a>
    <li><a href="#label-Install+and+Run+Locally">Install and Run Locally</a>
    <li><a href="#label-Prerequisites">Prerequisites</a>
    <li><a href="#label-Initial+setup-3A">Initial setup:</a>
    <li><a href="#label-Execute-3A">Execute:</a>
    <li><a href="#label-Understanding+the+Code+Base">Understanding the Code Base</a>
    <li><a href="#label-Testing">Testing</a>
    <li><a href="#label-Style+Guidelines+-26+Naming+Conventions">Style Guidelines &amp; Naming Conventions</a>
    <li><a href="#label-Creating+a+Pull+Request-3Ca+name-3D-22creating_a_pull_request-22-3E-3C-2Fa-3E">Creating a Pull Request&lt;a name=“creating_a_pull_request”&gt;&lt;/a&gt;</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/sendgrid-rest/CONTRIBUTING.md">

<p>Hello! Thank you for choosing to help contribute to one of the SendGrid
open source libraries. There are many ways you can contribute and help is
always welcome. We simply ask that you follow the following contribution
policies.</p>
<ul><li>
<p><a href="#cla">CLAs and CCLAs</a></p>
</li><li>
<p><a href="#roadmap">Roadmap & Milestones</a></p>
</li><li>
<p><a href="#feature_request">Feature Request</a></p>
</li><li>
<p><a href="#submit_a_bug_report">Submit a Bug Report</a></p>
</li><li>
<p><a href="#improvements_to_the_codebase">Improvements to the Codebase</a></p>
</li><li>
<p><a href="#understanding_the_codebase">Understanding the Code Base</a></p>
</li><li>
<p><a href="#testing">Testing</a></p>
</li><li>
<p><a href="#style_guidelines_and_naming_conventions">Style Guidelines &
Naming Conventions</a></p>
</li><li>
<p><a href="#creating_a_pull_request">Creating a Pull Request</a></p>
</li></ul>
<a name="roadmap"></a>
<p>We use <a
href="https://github.com/sendgrid/nodejs-http-client/milestones">Milestones</a>
to help define current roadmaps, please feel free to grab an issue from the
current milestone. Please indicate that you have begun work on it to avoid
collisions. Once a PR is made, community review, comments, suggestions and
additional PRs are welcomed and encouraged.</p>
<a name="cla"></a>
<h2 id="label-CLAs+and+CCLAs">CLAs and CCLAs<span><a href="#label-CLAs+and+CCLAs">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Before you get started, SendGrid requires that a SendGrid Contributor
License Agreement (CLA) be filled out by every contributor to a SendGrid
open source project.</p>

<p>Our goal with the CLA is to clarify the rights of our contributors and
reduce other risks arising from inappropriate contributions. The CLA also
clarifies the rights SendGrid holds in each contribution and helps to avoid
misunderstandings over what rights each contributor is required to grant to
SendGrid when making a contribution. In this way the CLA encourages broad
participation by our open source community and helps us build strong open
source projects, free from any individual contributor withholding or
revoking rights to any contribution.</p>

<p>SendGrid does not merge a pull request made against a SendGrid open source
project until that pull request is associated with a signed CLA. Copies of
the CLA are available <a
href="https://gist.github.com/SendGridDX/98b42c0a5d500058357b80278fde3be8#file-sendgrid_cla">here</a>.</p>

<p>When you create a Pull Request, after a few seconds, a comment will appear
with a link to the CLA. Click the link and fill out the brief form and then
click the “I agree” button and you are all set. You will not be asked to
re-sign the CLA unless we make a change.</p>

<p>There are a few ways to contribute, which we&#39;ll enumerate below:</p>
<a name="feature_request"></a>
<h2 id="label-Feature+Request">Feature Request<span><a href="#label-Feature+Request">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>If you&#39;d like to make a feature request, please read this section.</p>

<p>The GitHub issue tracker is the preferred channel for library feature
requests, but please respect the following restrictions:</p>
<ul><li>
<p>Please <strong>search for existing issues</strong> in order to ensure we
don&#39;t have duplicate bugs/feature requests.</p>
</li><li>
<p>Please be respectful and considerate of others when commenting on issues</p>
</li></ul>
<a name="submit_a_bug_report"></a>
<h2 id="label-Submit+a+Bug+Report">Submit a Bug Report<span><a href="#label-Submit+a+Bug+Report">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Note: DO NOT include your credentials in ANY code examples, descriptions,
or media you make public.</p>

<p>A software bug is a demonstrable issue in the code base. In order for us to
diagnose the issue and respond as quickly as possible, please add as much
detail as possible into your bug report.</p>

<p>Before you decide to create a new issue, please try the following:</p>
<ol><li>
<p>Check the Github issues tab if the identified issue has already been
reported, if so, please add a +1 to the existing post.</p>
</li><li>
<p>Update to the latest version of this code and check if issue has already
been fixed</p>
</li><li>
<p>Copy and fill in the Bug Report Template we have provided below</p>
</li></ol>

<h3 id="label-Please+use+our+Bug+Report+Template">Please use our Bug Report Template<span><a href="#label-Please+use+our+Bug+Report+Template">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>In order to make the process easier, we&#39;ve included a <a
href="https://github.com/sendgrid/nodejs-http-client/.github/ISSUE_TEMPLATE">sample
bug report template</a> (borrowed from <a
href="https://github.com/TryGhost/Ghost/">Ghost</a>). The template uses <a
href="https://help.github.com/articles/github-flavored-markdown/">GitHub
flavored markdown</a> for formatting.</p>
<a name="improvements_to_the_codebase"></a>
<h2 id="label-Improvements+to+the+Codebase">Improvements to the Codebase<span><a href="#label-Improvements+to+the+Codebase">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>We welcome direct contributions to the nodejs-http-client code base. Thank
you!</p>

<h3 id="label-Development+Environment">Development Environment<span><a href="#label-Development+Environment">&para;</a> <a href="#top">&uarr;</a></span></h3>

<h4 id="label-Install+and+Run+Locally">Install and Run Locally<span><a href="#label-Install+and+Run+Locally">&para;</a> <a href="#top">&uarr;</a></span></h4>

<h5 id="label-Prerequisites">Prerequisites<span><a href="#label-Prerequisites">&para;</a> <a href="#top">&uarr;</a></span></h5>
<ul><li>
<p>Node.js version 0.10, 0.12 or 4</p>
</li><li>
<p>Please see <a
href="https://github.com/sendgrid/nodejs-http-client/blob/master/package.json">package.json</a></p>
</li></ul>

<h5 id="label-Initial+setup-3A">Initial setup:<span><a href="#label-Initial+setup-3A">&para;</a> <a href="#top">&uarr;</a></span></h5>

<pre>git clone https://github.com/sendgrid/nodejs-http-client.git
cd nodejs-http-client
npm install</pre>

<h5 id="label-Execute-3A">Execute:<span><a href="#label-Execute-3A">&para;</a> <a href="#top">&uarr;</a></span></h5>

<p>See the <a
href="https://github.com/sendgrid/nodejs-http-client/tree/master/examples">examples
folder</a> to get started quickly.</p>

<p>You will need to setup the following environment to use the SendGrid
example:</p>

<pre>echo &quot;export SENDGRID_API_KEY=&#39;YOUR_API_KEY&#39;&quot; &gt; sendgrid.env
echo &quot;sendgrid.env&quot; &gt;&gt; .gitignore
source ./sendgrid.env
node examples/example.js</pre>

<p>To run the example:</p>

<pre class="ruby"><span class="ruby-identifier">node</span> .<span class="ruby-operator">/</span><span class="ruby-identifier">examples</span><span class="ruby-operator">/</span><span class="ruby-identifier">example</span>.<span class="ruby-identifier">js</span>
</pre>
<a name="understanding_the_codebase"></a>
<h2 id="label-Understanding+the+Code+Base">Understanding the Code Base<span><a href="#label-Understanding+the+Code+Base">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p><strong>/examples</strong></p>

<p>Working examples that demonstrate usage.</p>

<p><strong>client.js</strong></p>

<p>There is a object to hold both the request and response to the API server.</p>

<p>The main function that does the heavy lifting (and external entry point) is
<code>API</code>.</p>
<a name="testing"></a>
<h2 id="label-Testing">Testing<span><a href="#label-Testing">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>All PRs require passing tests before the PR will be reviewed.</p>

<p>All test files are in <a
href="https://github.com/sendgrid/nodejs-http-client/blob/master/test/test.js">test/test.js</a>.</p>

<p>For the purposes of contributing to this repo, please update the <a
href="https://github.com/sendgrid/nodejs-http-client/blob/master/test/test.js">test.js</a>
file with unit tests as you modify the code.</p>

<p>Run the test:</p>

<p><code>mocha</code></p>
<a name="style_guidelines_and_naming_conventions"></a>
<h2 id="label-Style+Guidelines+-26+Naming+Conventions">Style Guidelines &amp; Naming Conventions<span><a href="#label-Style+Guidelines+-26+Naming+Conventions">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Generally, we follow the style guidelines as suggested by the official
language. However, we ask that you conform to the styles that already exist
in the library. If you wish to deviate, please explain your reasoning.</p>
<ul><li>
<p><a href="https://github.com/felixge/node-style-guide">Unofficial Style
Guide</a></p>
</li></ul>

<p>Please run your code through:</p>
<ul><li>
<p><a href="http://eslint.org/">ESLint</a> with the standard style guide.</p>
</li></ul>

<h2 id="label-Creating+a+Pull+Request-3Ca+name-3D-22creating_a_pull_request-22-3E-3C-2Fa-3E">Creating a Pull Request&lt;a name=“creating_a_pull_request”&gt;&lt;/a&gt;<span><a href="#label-Creating+a+Pull+Request-3Ca+name-3D-22creating_a_pull_request-22-3E-3C-2Fa-3E">&para;</a> <a href="#top">&uarr;</a></span></h2>
<ol><li>
<p><a href="https://help.github.com/fork-a-repo/">Fork</a> the project, clone
your fork,  and configure the remotes:</p>
</li></ol>

<p><code>bash    # Clone your fork of the repo into the current directory   
git clone https://github.com/sendgrid/nodejs-http-client    # Navigate to
the newly cloned directory    cd sendgrid-python    # Assign the original
repo to a remote called &quot;upstream&quot;    git remote add upstream
https://github.com/sendgrid/nodejs-http-client </code></p>
<ol><li>
<p>If you cloned a while ago, get the latest changes from upstream:</p>
</li></ol>

<p><code>bash    git checkout &lt;dev-branch&gt;    git pull upstream
&lt;dev-branch&gt; </code></p>
<ol><li>
...
<p><code>bash    git checkout -b &lt;topic-branch-name&gt; </code></p>
<ol><li>
<p>Commit your changes in logical chunks. Please adhere to these <a
href="http://tbaggery.com/2008/04/19/a-note-about-git-commit-messages.html">git
commit message guidelines</a>  or your code is unlikely be merged into the
main project. Use Git&#39;s  <a
href="https://help.github.com/articles/interactive-rebase">interactive
rebase</a>  feature to tidy up your commits before making them public.</p>
</li></ol>

<p>4a. Create tests.</p>

<p>4b. Create or update the example code that demonstrates the functionality
of this change to the code.</p>
<ol><li>
<p>Locally merge (or rebase) the upstream development branch into your topic
branch:</p>
</li></ol>

<p><code>bash    git pull [--rebase] upstream master </code></p>
<ol><li>
<p>Push your topic branch up to your fork:</p>
</li></ol>

<p><code>bash    git push origin &lt;topic-branch-name&gt; </code></p>
<ol><li>
<p><a href="https://help.github.com/articles/using-pull-requests/">Open a Pull
Request</a> with a clear title and description against the
<code>master</code> branch. All tests must be passing before we will review
the PR.</p>
</li></ol>

<p>If you have any additional questions, please feel free to <a
href="mailto:dx@sendgrid.com">email</a> us or create an issue in this repo.</p>
</main>
