...
<main role="main" aria-label="Page node_modules/sendgrid-rest/examples/example.js">

<p>var Client = require(&#39;../lib/client.js&#39;).Client</p>

<p>// These values persist across of subsequent calls, unless overidden. var
globalRequest = require(&#39;../lib/client.js&#39;).emptyRequest
globalRequest.host = &#39;api.sendgrid.com&#39;; // You must add your
SendGrid API Key to your OS Environment <a
href="'Authorization'">globalRequest.headers</a> = &#39;Bearer
&#39;.concat(process.env.SENDGRID_API_KEY) var client = new
Client(globalRequest)</p>

<p>// GET Collection var requestGet = client.emptyRequest() requestGet.method
= &#39;GET&#39; requestGet.path = &#39;/v3/api_keys&#39; <a
href="'limit'">requestGet.queryParams</a> = 100 <a
href="'offset'">requestGet.queryParams</a> = 0 client.API(requestGet,
function (response) {</p>
...
<p>// POST var requestBody = {</p>

<pre>&#39;name&#39;: &#39;My API Key from Node.js&#39;,
&#39;scopes&#39;: [
  &#39;mail.send&#39;,
  &#39;alerts.create&#39;,
  &#39;alerts.read&#39;
...
<p>} var requestPost = client.emptyRequest() requestPost.method =
&#39;POST&#39; requestPost.path = &#39;/v3/api_keys&#39; requestPost.body =
requestBody <a href="'X-Test'">requestPost.headers</a> = &#39;test&#39;
function createAPIKey (callback) {</p>

<pre>client.API(requestPost, function (response) {
...
<p>createAPIKey(function (returnValue) { // This ensures we POST a new key
first, to get the api_key_id</p>

<pre>var api_key_id = &#39;/&#39;.concat(returnValue)
