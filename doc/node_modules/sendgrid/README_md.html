...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    ...
    <li><a href="#label-Setup+Environment+Variables">Setup Environment Variables</a>
    <li><a href="#label-Install+Package">Install Package</a>
    <li><a href="#label-Dependencies">Dependencies</a>
    <li><a href="#label-Quick+Start">Quick Start</a>
    <li><a href="#label-Hello+Email">Hello Email</a>
    <li><a href="#label-With+Mail+Helper+Class">With Mail Helper Class</a>
    <li><a href="#label-Without+Mail+Helper+Class">Without Mail Helper Class</a>
    <li><a href="#label-General+v3+Web+API+Usage">General v3 Web API Usage</a>
    <li><a href="#label-Usage">Usage</a>
    <li><a href="#label-Use+Cases">Use Cases</a>
    <li><a href="#label-Announcements">Announcements</a>
...
<main role="main" aria-label="Page node_modules/sendgrid/README.md">

<p><a href="https://travis-ci.org/sendgrid/sendgrid-nodejs"><img
src="https://travis-ci.org/sendgrid/sendgrid-nodejs.svg?branch=master"></a>
<a href="https://badge.fury.io/js/sendgrid"><img
src="https://badge.fury.io/js/sendgrid.svg"></a></p>

<p>Please see our announcement regarding <a
href="https://github.com/sendgrid/sendgrid-nodejs/issues/290">breaking
changes</a>. Your support is appreciated!</p>

<p><strong>This library allows you to quickly and easily use the SendGrid Web
API v3 via Node.js.</strong></p>

<p>Version 3.X.X+ of this library provides full support for all SendGrid <a
href="https://sendgrid.com/docs/API_Reference/Web_API_v3/index.html">Web
API v3</a> endpoints, including the new <a
href="https://sendgrid.com/blog/introducing-v3mailsend-sendgrids-new-mail-endpoint">v3
/mail/send</a>.</p>

<p>This library represents the beginning of a new path for SendGrid. We want
this library to be community driven and SendGrid led. We need your help to
realize this goal. To help make sure we are building the right things in
the right order, we ask that you create <a
href="https://github.com/sendgrid/sendgrid-nodejs/issues">issues</a> and <a
href="https://github.com/sendgrid/sendgrid-nodejs/blob/master/CONTRIBUTING.md">pull
requests</a> or simply upvote or comment on existing issues or pull
requests.</p>

<p>Please browse the rest of this <a href="../../README_md.html">README</a>
for further detail.</p>

<p>We appreciate your continued support, thank you!</p>

<h1 id="label-Table+of+Contents">Table of Contents<span><a href="#label-Table+of+Contents">&para;</a> <a href="#top">&uarr;</a></span></h1>
<ul><li>
<p><a href="#installation">Installation</a></p>
</li><li>
<p><a href="#quick_start">Quick Start</a></p>
</li><li>
<p><a href="#usage">Usage</a></p>
</li><li>
<p><a href="#use_cases">Use Cases</a></p>
</li><li>
<p><a href="#announcements">Announcements</a></p>
</li><li>
<p><a href="#roadmap">Roadmap</a></p>
</li><li>
<p><a href="#contribute">How to Contribute</a></p>
</li><li>
...
<h2 id="label-Prerequisites">Prerequisites<span><a href="#label-Prerequisites">&para;</a> <a href="#top">&uarr;</a></span></h2>
<ul><li>
<p>Node.js version 4, 6 or 7</p>
</li><li>
<p>The SendGrid service, starting at the <a
href="https://sendgrid.com/free?source=sendgrid-nodejs">free level</a></p>
</li></ul>

<h2 id="label-Setup+Environment+Variables">Setup Environment Variables<span><a href="#label-Setup+Environment+Variables">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Update the development environment with your <a
href="https://app.sendgrid.com/settings/api_keys">SENDGRID_API_KEY</a>, for
example:</p>

<pre>echo &quot;export SENDGRID_API_KEY=&#39;YOUR_API_KEY&#39;&quot; &gt; sendgrid.env
echo &quot;sendgrid.env&quot; &gt;&gt; .gitignore
source ./sendgrid.env</pre>

<h2 id="label-Install+Package">Install Package<span><a href="#label-Install+Package">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The following recommended installation requires <a
href="https://npmjs.org/">npm</a>. If you are unfamiliar with npm, see the
<a href="https://npmjs.org/doc/">npm docs</a>. Npm comes installed with
Node.js since node version 0.8.x therefore you likely already have it.</p>

<pre>npm install --save sendgrid</pre>

<h2 id="label-Dependencies">Dependencies<span><a href="#label-Dependencies">&para;</a> <a href="#top">&uarr;</a></span></h2>
<ul><li>
<p><a
href="https://github.com/sendgrid/nodejs-http-client">Nodejs-HTTP-Client</a></p>
</li></ul>
<a name="quick_start"></a>
<h1 id="label-Quick+Start">Quick Start<span><a href="#label-Quick+Start">&para;</a> <a href="#top">&uarr;</a></span></h1>

<h2 id="label-Hello+Email">Hello Email<span><a href="#label-Hello+Email">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>The following is the minimum needed code to send an email with the <a
href="https://github.com/sendgrid/sendgrid-nodejs/tree/master/lib/helpers/mail">/mail/send
Helper</a> (<a
href="https://github.com/sendgrid/sendgrid-nodejs/blob/master/examples/helpers/mail/example.js#L15">here</a>
is a full example):</p>

<h3 id="label-With+Mail+Helper+Class">With Mail Helper Class<span><a href="#label-With+Mail+Helper+Class">&para;</a> <a href="#top">&uarr;</a></span></h3>

<pre>var helper = require(&#39;sendgrid&#39;).mail;
...
<p>The <code>Mail</code> constructor creates a <a
href="https://sendgrid.com/docs/Classroom/Send/v3_Mail_Send/personalizations.html">personalization
object</a> for you. <a
href="https://github.com/sendgrid/sendgrid-nodejs/blob/master/examples/helpers/mail/example.js#L10">Here</a>
is an example of how to add to it.</p>

<h3 id="label-Without+Mail+Helper+Class">Without Mail Helper Class<span><a href="#label-Without+Mail+Helper+Class">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>The following is the minimum needed code to send an email without the
/mail/send Helper (<a
href="https://github.com/sendgrid/sendgrid-nodejs/blob/master/examples/mail/mail.js#L31">here</a>
is a full example):</p>

<pre>var sg = require(&#39;sendgrid&#39;)(process.env.SENDGRID_API_KEY);
var request = sg.emptyRequest({
  method: &#39;POST&#39;,
  path: &#39;/v3/mail/send&#39;,
  body: {
...
<h2 id="label-General+v3+Web+API+Usage">General v3 Web API Usage<span><a href="#label-General+v3+Web+API+Usage">&para;</a> <a href="#top">&uarr;</a></span></h2>
...
<ul><li>
<p><a
href="https://sendgrid.com/docs/API_Reference/Web_API_v3/index.html">SendGrid
Docs</a></p>
</li><li>
<p><a
href="https://github.com/sendgrid/sendgrid-nodejs/blob/master/USAGE.md">Library
Usage Docs</a></p>
</li><li>
<p><a
href="https://github.com/sendgrid/sendgrid-nodejs/tree/master/examples">Example
Code</a></p>
</li><li>
<p><a
href="https://sendgrid.com/docs/Classroom/Send/v3_Mail_Send/how_to_migrate_from_v2_to_v3_mail_send.html">How-to:
Migration from v2 to v3</a></p>
</li><li>
<p><a
href="https://github.com/sendgrid/sendgrid-nodejs/tree/master/lib/helpers/mail/README.md">v3
Web API Mail Send Helper</a></p>
</li></ul>
<a name="use_cases"></a>
<h1 id="label-Use+Cases">Use Cases<span><a href="#label-Use+Cases">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p><a
href="https://github.com/sendgrid/sendgrid-nodejs/blob/master/USE_CASES.md">Examples
of common API use cases</a>, such as how to send an email with a
transactional template.</p>
<a name="announcements"></a>
<h1 id="label-Announcements">Announcements<span><a href="#label-Announcements">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>Please see our announcement regarding <a
href="https://github.com/sendgrid/sendgrid-nodejs/issues/290">breaking
changes</a>. Your support is appreciated!</p>

<p>All updates to this library is documented in our <a
href="https://github.com/sendgrid/sendgrid-nodejs/blob/master/CHANGELOG.md">CHANGELOG</a>
and <a
href="https://github.com/sendgrid/sendgrid-nodejs/releases">releases</a>.</p>
<a name="roadmap"></a>
<h1 id="label-Roadmap">Roadmap<span><a href="#label-Roadmap">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>If you are interested in the future direction of this project, please take
a look at our open <a
href="https://github.com/sendgrid/sendgrid-nodejs/issues">issues</a> and <a
href="https://github.com/sendgrid/sendgrid-nodejs/pulls">pull requests</a>.
...
<p>We encourage contribution to our libraries (you might even score some nifty
swag), please see our <a
href="https://github.com/sendgrid/sendgrid-nodejs/blob/master/CONTRIBUTING.md">CONTRIBUTING</a>
guide for details.</p>
<ul><li>
<p><a
href="https://github.com/sendgrid/sendgrid-nodejs/tree/master/CONTRIBUTING.md#feature_request">Feature
Request</a></p>
</li><li>
<p><a
href="https://github.com/sendgrid/sendgrid-nodejs/tree/master/CONTRIBUTING.md#submit_a_bug_report">Bug
Reports</a></p>
</li><li>
<p><a
href="https://github.com/sendgrid/sendgrid-nodejs/tree/master/CONTRIBUTING.md#improvements_to_the_codebase">Improvements
to the Codebase</a></p>
</li></ul>
...
<p>Please see our <a
href="https://github.com/sendgrid/sendgrid-nodejs/blob/master/TROUBLESHOOTING.md">troubleshooting
guide</a> for common library issues.</p>
<a name="about"></a>
<h1 id="label-About">About<span><a href="#label-About">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>sendgrid-nodejs is guided and supported by the SendGrid <a
href="mailto:dx@sendgrid.com">Developer Experience Team</a>.</p>

<p>sendgrid-nodejs is maintained and funded by SendGrid, Inc. The names and
logos for sendgrid-nodejs are trademarks of SendGrid, Inc.</p>

<p><img src="https://uiux.s3.amazonaws.com/2016-logos/email-logo%402x.png"></p>
</main>
