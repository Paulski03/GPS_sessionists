...
<title>apikeys.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/sendgrid/examples/apikeys/apikeys.js">
...
<p>}; request.method = &#39;POST&#39; request.path = &#39;/v3/api_keys&#39;
...
<p>/////////////////////////////////////////////////// // Retrieve all API
Keys belonging to the authenticated user // GET /api_keys</p>

<p>var request = sg.emptyRequest() <a href=""limit"">request.queryParams</a> =
&#39;1&#39;</p>

<p>request.method = &#39;GET&#39; request.path = &#39;/v3/api_keys&#39;
sg.API(request, function (error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Update the name
&amp; scopes of an API Key // PUT /api_keys/{api_key_id}</p>
...
&#39;/v3/api_keys/{api_key_id}&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // Update API keys //
PATCH /api_keys/{api_key_id}</p>

<p>var request = sg.emptyRequest() request.body = {</p>

<pre>&quot;name&quot;: &quot;A New Hope&quot;</pre>
...
API Key // GET /api_keys/{api_key_id}</p>
...
<p>/////////////////////////////////////////////////// // Delete API keys //
DELETE /api_keys/{api_key_id}</p>

<p>var request = sg.emptyRequest() request.method = &#39;DELETE&#39;
request.path = &#39;/v3/api_keys/{api_key_id}&#39; sg.API(request, function
(error, response) {</p>
