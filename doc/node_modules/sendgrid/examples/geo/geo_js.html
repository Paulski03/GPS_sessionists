...
<main role="main" aria-label="Page node_modules/sendgrid/examples/geo/geo.js">

<p>var sg = require(&#39;sendgrid&#39;)(process.env.SENDGRID_API_KEY)</p>

<p>/////////////////////////////////////////////////// // Retrieve email
statistics by country and state/province. // GET /geo/stats</p>

<p>var request = sg.emptyRequest() <a
href=""end_date"">request.queryParams</a> = &#39;2016-04-01&#39;</p>

<pre class="ruby"><span class="ruby-identifier">request</span>.<span class="ruby-identifier">queryParams</span>[<span class="ruby-string">&quot;country&quot;</span>] = <span class="ruby-string">&#39;US&#39;</span>
...
<p>request.method = &#39;GET&#39; request.path = &#39;/v3/geo/stats&#39;
