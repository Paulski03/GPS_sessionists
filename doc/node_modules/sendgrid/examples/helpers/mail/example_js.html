...
<title>example.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/sendgrid/examples/helpers/mail/example.js">

<p>function helloEmail(){</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">helper</span> = <span class="ruby-identifier">require</span>(<span class="ruby-string">&#39;sendgrid&#39;</span>).<span class="ruby-identifier">mail</span>

<span class="ruby-identifier">from_email</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">Email</span>(<span class="ruby-string">&quot;test@example.com&quot;</span>)
<span class="ruby-identifier">to_email</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">Email</span>(<span class="ruby-string">&quot;test@example.com&quot;</span>)
<span class="ruby-identifier">subject</span> = <span class="ruby-string">&quot;Hello World from the SendGrid Node.js Library&quot;</span>
...
<span class="ruby-identifier">mail</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">Mail</span>(<span class="ruby-identifier">from_email</span>, <span class="ruby-identifier">subject</span>, <span class="ruby-identifier">to_email</span>, <span class="ruby-identifier">content</span>)
<span class="ruby-identifier">email</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">Email</span>(<span class="ruby-string">&quot;test2@example.com&quot;</span>)
<span class="ruby-identifier">mail</span>.<span class="ruby-identifier">personalizations</span>[<span class="ruby-value">0</span>].<span class="ruby-identifier">addTo</span>(<span class="ruby-identifier">email</span>)

<span class="ruby-keyword">return</span> <span class="ruby-identifier">mail</span>.<span class="ruby-identifier">toJSON</span>()
</pre>

<p>}</p>

<p>function kitchenSink(){</p>
...
return mail.toJSON()</pre>

<p>}</p>

<p>function send(toSend){</p>

<pre>console.log(JSON.stringify(toSend, null, 2))
...
<p>send(helloEmail()) send(kitchenSink())</p>
</main>
