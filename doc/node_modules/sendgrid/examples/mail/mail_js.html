...
<title>mail.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/sendgrid/examples/mail/mail.js">
...
request.path = &#39;/v3/mail/batch&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // Validate batch ID //
GET /mail/batch/{batch_id}</p>

<p>var request = sg.emptyRequest() request.method = &#39;GET&#39; request.path
= &#39;/v3/mail/batch/{batch_id}&#39; sg.API(request, function (error,
response) {</p>
...
<p>// This endpoint has a helper, check it out [here](<a
href="https://github.com/sendgrid/sendgrid-nodejs/blob/master/lib/helpers/mail/README.md">github.com/sendgrid/sendgrid-nodejs/blob/master/lib/helpers/mail/README.md</a>).</p>
...
<p>}; request.method = &#39;POST&#39; request.path = &#39;/v3/mail/send&#39;
