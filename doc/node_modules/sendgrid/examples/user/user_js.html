...
<title>user.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/sendgrid/examples/user/user.js">

<p>var sg = require(&#39;sendgrid&#39;)(process.env.SENDGRID_API_KEY)</p>

<p>/////////////////////////////////////////////////// // Get a user&#39;s
account information. // GET /user/account</p>

<p>var request = sg.emptyRequest() request.method = &#39;GET&#39; request.path
= &#39;/v3/user/account&#39; sg.API(request, function (error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Retrieve your credit
balance // GET /user/credits</p>

<p>var request = sg.emptyRequest() request.method = &#39;GET&#39; request.path
= &#39;/v3/user/credits&#39; sg.API(request, function (error, response) {</p>
...
email address // PUT /user/email</p>

<p>var request = sg.emptyRequest() request.body = {</p>

<pre>&quot;email&quot;: &quot;example@example.com&quot;</pre>

<p>}; request.method = &#39;PUT&#39; request.path = &#39;/v3/user/email&#39;
...
<p>/////////////////////////////////////////////////// // Retrieve your
account email address // GET /user/email</p>

<p>var request = sg.emptyRequest() request.method = &#39;GET&#39; request.path
= &#39;/v3/user/email&#39; sg.API(request, function (error, response) {</p>
...
<pre>&quot;new_password&quot;: &quot;new_password&quot;, 
&quot;old_password&quot;: &quot;old_password&quot;</pre>

<p>}; request.method = &#39;PUT&#39; request.path =
&#39;/v3/user/password&#39; sg.API(request, function (error, response) {</p>
...
&#39;/v3/user/profile&#39; sg.API(request, function (error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Cancel or pause a
scheduled send // POST /user/scheduled_sends</p>

<p>var request = sg.emptyRequest() request.body = {</p>

<pre>&quot;batch_id&quot;: &quot;YOUR_BATCH_ID&quot;, 
&quot;status&quot;: &quot;pause&quot;</pre>

<p>}; request.method = &#39;POST&#39; request.path =
&#39;/v3/user/scheduled_sends&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // Retrieve all
scheduled sends // GET /user/scheduled_sends</p>
...
<p>/////////////////////////////////////////////////// // Update user
scheduled send information // PATCH /user/scheduled_sends/{batch_id}</p>

<p>var request = sg.emptyRequest() request.body = {</p>

<pre>&quot;status&quot;: &quot;pause&quot;</pre>

<p>}; request.method = &#39;PATCH&#39; request.path =
&#39;/v3/user/scheduled_sends/{batch_id}&#39; sg.API(request, function
(error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Retrieve scheduled
send // GET /user/scheduled_sends/{batch_id}</p>
...
<p>/////////////////////////////////////////////////// // Delete a
cancellation or pause of a scheduled send // DELETE
/user/scheduled_sends/{batch_id}</p>
...
<p>/////////////////////////////////////////////////// // Update Enforced TLS
settings // PATCH /user/settings/enforced_tls</p>

<p>var request = sg.emptyRequest() request.body = {</p>

<pre>&quot;require_tls&quot;: true, 
&quot;require_valid_cert&quot;: false</pre>

<p>}; request.method = &#39;PATCH&#39; request.path =
&#39;/v3/user/settings/enforced_tls&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // Retrieve current
Enforced TLS settings. // GET /user/settings/enforced_tls</p>
...
<pre>&quot;username&quot;: &quot;test_username&quot;</pre>

<p>}; request.method = &#39;PUT&#39; request.path =
&#39;/v3/user/username&#39; sg.API(request, function (error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Update Event
Notification Settings // PATCH /user/webhooks/event/settings</p>
...
<p>}; request.method = &#39;PATCH&#39; request.path =
&#39;/v3/user/webhooks/event/settings&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // Retrieve Event
Webhook settings // GET /user/webhooks/event/settings</p>

<p>var request = sg.emptyRequest() request.method = &#39;GET&#39; request.path
= &#39;/v3/user/webhooks/event/settings&#39; sg.API(request, function
(error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Test Event
Notification Settings  // POST /user/webhooks/event/test</p>
...
<p>}; request.method = &#39;POST&#39; request.path =
&#39;/v3/user/webhooks/event/test&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // Create a parse
setting // POST /user/webhooks/parse/settings</p>

<p>var request = sg.emptyRequest() request.body = {</p>

<pre>&quot;hostname&quot;: &quot;myhostname.com&quot;, 
&quot;send_raw&quot;: false, 
&quot;spam_check&quot;: true, 
&quot;url&quot;: &quot;http://email.myhosthame.com&quot;</pre>

<p>}; request.method = &#39;POST&#39; request.path =
&#39;/v3/user/webhooks/parse/settings&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // Retrieve all parse
settings // GET /user/webhooks/parse/settings</p>

<p>var request = sg.emptyRequest() request.method = &#39;GET&#39; request.path
= &#39;/v3/user/webhooks/parse/settings&#39; sg.API(request, function
(error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Update a parse
setting // PATCH /user/webhooks/parse/settings/{hostname}</p>

<p>var request = sg.emptyRequest() request.body = {</p>

<pre>&quot;send_raw&quot;: true, 
&quot;spam_check&quot;: false, 
&quot;url&quot;: &quot;http://newdomain.com/parse&quot;</pre>

<p>}; request.method = &#39;PATCH&#39; request.path =
&#39;/v3/user/webhooks/parse/settings/{hostname}&#39; sg.API(request,
...
<p>/////////////////////////////////////////////////// // Retrieve a specific
parse setting // GET /user/webhooks/parse/settings/{hostname}</p>
...
<p>/////////////////////////////////////////////////// // Delete a parse
setting // DELETE /user/webhooks/parse/settings/{hostname}</p>
...
<p>/////////////////////////////////////////////////// // Retrieves Inbound
Parse Webhook statistics. // GET /user/webhooks/parse/stats</p>

<p>var request = sg.emptyRequest() <a
href=""aggregated_by"">request.queryParams</a> = &#39;day&#39;</p>

<pre class="ruby"><span class="ruby-identifier">request</span>.<span class="ruby-identifier">queryParams</span>[<span class="ruby-string">&quot;limit&quot;</span>] = <span class="ruby-string">&#39;test_string&#39;</span>
...
<span class="ruby-identifier">request</span>.<span class="ruby-identifier">queryParams</span>[<span class="ruby-string">&quot;end_date&quot;</span>] = <span class="ruby-string">&#39;2016-04-01&#39;</span>
<span class="ruby-identifier">request</span>.<span class="ruby-identifier">queryParams</span>[<span class="ruby-string">&quot;offset&quot;</span>] = <span class="ruby-string">&#39;test_string&#39;</span>
</pre>

<p>request.method = &#39;GET&#39; request.path =
&#39;/v3/user/webhooks/parse/stats&#39; sg.API(request, function (error,
response) {</p>
