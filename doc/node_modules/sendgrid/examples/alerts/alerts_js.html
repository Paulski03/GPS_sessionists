...
<title>alerts.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/sendgrid/examples/alerts/alerts.js">

<p>var sg = require(&#39;sendgrid&#39;)(process.env.SENDGRID_API_KEY)</p>

<p>/////////////////////////////////////////////////// // Create a new Alert
// POST /alerts</p>

<p>var request = sg.emptyRequest() request.body = {</p>

<pre>&quot;email_to&quot;: &quot;example@example.com&quot;, 
&quot;frequency&quot;: &quot;daily&quot;, 
&quot;type&quot;: &quot;stats_notification&quot;</pre>

<p>}; request.method = &#39;POST&#39; request.path = &#39;/v3/alerts&#39;
...
<p>/////////////////////////////////////////////////// // Retrieve all alerts
// GET /alerts</p>

<p>var request = sg.emptyRequest() request.method = &#39;GET&#39; request.path
= &#39;/v3/alerts&#39; sg.API(request, function (error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Update an alert //
PATCH /alerts/{alert_id}</p>

<p>var request = sg.emptyRequest() request.body = {</p>

<pre>&quot;email_to&quot;: &quot;example@example.com&quot;</pre>

<p>}; request.method = &#39;PATCH&#39; request.path =
&#39;/v3/alerts/{alert_id}&#39; sg.API(request, function (error, response)
{</p>
...
alert // GET /alerts/{alert_id}</p>

<p>var request = sg.emptyRequest() request.method = &#39;GET&#39; request.path
= &#39;/v3/alerts/{alert_id}&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // Delete an alert //
DELETE /alerts/{alert_id}</p>

<p>var request = sg.emptyRequest() request.method = &#39;DELETE&#39;
request.path = &#39;/v3/alerts/{alert_id}&#39; sg.API(request, function
(error, response) {</p>
