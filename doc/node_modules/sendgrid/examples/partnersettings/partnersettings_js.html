...
<title>partnersettings.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/sendgrid/examples/partnersettings/partnersettings.js">

<p>var sg = require(&#39;sendgrid&#39;)(process.env.SENDGRID_API_KEY)</p>

<p>/////////////////////////////////////////////////// // Returns a list of
all partner settings. // GET /partner_settings</p>
...
&#39;/v3/partner_settings&#39; sg.API(request, function (error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Updates New Relic
partner settings. // PATCH /partner_settings/new_relic</p>

<p>var request = sg.emptyRequest() request.body = {</p>

<pre>&quot;enable_subuser_statistics&quot;: true, 
&quot;enabled&quot;: true, 
&quot;license_key&quot;: &quot;&quot;</pre>

<p>}; request.method = &#39;PATCH&#39; request.path =
&#39;/v3/partner_settings/new_relic&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // Returns all New
Relic partner settings. // GET /partner_settings/new_relic</p>
