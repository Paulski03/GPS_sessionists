...
<title>whitelabel.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/sendgrid/examples/whitelabel/whitelabel.js">

<p>var sg = require(&#39;sendgrid&#39;)(process.env.SENDGRID_API_KEY)</p>

<p>/////////////////////////////////////////////////// // Create a domain
whitelabel. // POST /whitelabel/domains</p>

<p>var request = sg.emptyRequest() request.body = {</p>

<pre>&quot;automatic_security&quot;: false, 
&quot;custom_spf&quot;: true, 
&quot;default&quot;: true, 
&quot;domain&quot;: &quot;example.com&quot;, 
&quot;ips&quot;: [
...
&quot;subdomain&quot;: &quot;news&quot;, 
&quot;username&quot;: &quot;john@example.com&quot;</pre>

<p>}; request.method = &#39;POST&#39; request.path =
&#39;/v3/whitelabel/domains&#39; sg.API(request, function (error, response)
{</p>

<pre class="ruby"><span class="ruby-identifier">console</span>.<span class="ruby-identifier">log</span>(<span class="ruby-identifier">response</span>.<span class="ruby-identifier">statusCode</span>)
<span class="ruby-identifier">console</span>.<span class="ruby-identifier">log</span>(<span class="ruby-identifier">response</span>.<span class="ruby-identifier">body</span>)
<span class="ruby-identifier">console</span>.<span class="ruby-identifier">log</span>(<span class="ruby-identifier">response</span>.<span class="ruby-identifier">headers</span>)
</pre>

<p>})</p>

<p>/////////////////////////////////////////////////// // List all domain
whitelabels. // GET /whitelabel/domains</p>

<p>var request = sg.emptyRequest() <a
href=""username"">request.queryParams</a> = &#39;test_string&#39;</p>

<pre class="ruby"><span class="ruby-identifier">request</span>.<span class="ruby-identifier">queryParams</span>[<span class="ruby-string">&quot;domain&quot;</span>] = <span class="ruby-string">&#39;test_string&#39;</span>
<span class="ruby-identifier">request</span>.<span class="ruby-identifier">queryParams</span>[<span class="ruby-string">&quot;exclude_subusers&quot;</span>] = <span class="ruby-string">&#39;true&#39;</span>
<span class="ruby-identifier">request</span>.<span class="ruby-identifier">queryParams</span>[<span class="ruby-string">&quot;limit&quot;</span>] = <span class="ruby-string">&#39;1&#39;</span>
<span class="ruby-identifier">request</span>.<span class="ruby-identifier">queryParams</span>[<span class="ruby-string">&quot;offset&quot;</span>] = <span class="ruby-string">&#39;1&#39;</span>
</pre>

<p>request.method = &#39;GET&#39; request.path =
&#39;/v3/whitelabel/domains&#39; sg.API(request, function (error, response)
{</p>
...
<p>/////////////////////////////////////////////////// // Get the default
domain whitelabel. // GET /whitelabel/domains/default</p>

<p>var request = sg.emptyRequest() request.method = &#39;GET&#39; request.path
= &#39;/v3/whitelabel/domains/default&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // List the domain
whitelabel associated with the given user. // GET
/whitelabel/domains/subuser</p>

<p>var request = sg.emptyRequest() request.method = &#39;GET&#39; request.path
= &#39;/v3/whitelabel/domains/subuser&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // Disassociate a
domain whitelabel from a given user. // DELETE /whitelabel/domains/subuser</p>

<p>var request = sg.emptyRequest() request.method = &#39;DELETE&#39;
request.path = &#39;/v3/whitelabel/domains/subuser&#39; sg.API(request,
...
<p>/////////////////////////////////////////////////// // Update a domain
whitelabel. // PATCH /whitelabel/domains/{domain_id}</p>
...
<p>}; request.method = &#39;PATCH&#39; request.path =
&#39;/v3/whitelabel/domains/{domain_id}&#39; sg.API(request, function
(error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Retrieve a domain
whitelabel. // GET /whitelabel/domains/{domain_id}</p>
...
<p>/////////////////////////////////////////////////// // Delete a domain
whitelabel. // DELETE /whitelabel/domains/{domain_id}</p>

<p>var request = sg.emptyRequest() request.method = &#39;DELETE&#39;
request.path = &#39;/v3/whitelabel/domains/{domain_id}&#39; sg.API(request,
function (error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Associate a domain
whitelabel with a given user. // POST
/whitelabel/domains/{domain_id}/subuser</p>

<p>var request = sg.emptyRequest() request.body = {</p>

<pre>&quot;username&quot;: &quot;jane@example.com&quot;</pre>

<p>}; request.method = &#39;POST&#39; request.path =
&#39;/v3/whitelabel/domains/{domain_id}/subuser&#39; sg.API(request,
function (error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Add an IP to a
domain whitelabel. // POST /whitelabel/domains/{id}/ips</p>

<p>var request = sg.emptyRequest() request.body = {</p>

<pre>&quot;ip&quot;: &quot;192.168.0.1&quot;</pre>

<p>}; request.method = &#39;POST&#39; request.path =
&#39;/v3/whitelabel/domains/{id}/ips&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // Remove an IP from a
domain whitelabel. // DELETE /whitelabel/domains/{id}/ips/{ip}</p>

<p>var request = sg.emptyRequest() request.method = &#39;DELETE&#39;
request.path = &#39;/v3/whitelabel/domains/{id}/ips/{ip}&#39;
sg.API(request, function (error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Validate a domain
whitelabel. // POST /whitelabel/domains/{id}/validate</p>

<p>var request = sg.emptyRequest() request.method = &#39;POST&#39;
...
<p>/////////////////////////////////////////////////// // Create an IP
whitelabel // POST /whitelabel/ips</p>
...
<p>}; request.method = &#39;POST&#39; request.path =
&#39;/v3/whitelabel/ips&#39; sg.API(request, function (error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Retrieve all IP
whitelabels // GET /whitelabel/ips</p>

<p>var request = sg.emptyRequest() <a href=""ip"">request.queryParams</a> =
&#39;test_string&#39;</p>

<pre class="ruby"><span class="ruby-identifier">request</span>.<span class="ruby-identifier">queryParams</span>[<span class="ruby-string">&quot;limit&quot;</span>] = <span class="ruby-string">&#39;1&#39;</span>
<span class="ruby-identifier">request</span>.<span class="ruby-identifier">queryParams</span>[<span class="ruby-string">&quot;offset&quot;</span>] = <span class="ruby-string">&#39;1&#39;</span>
</pre>

<p>request.method = &#39;GET&#39; request.path = &#39;/v3/whitelabel/ips&#39;
sg.API(request, function (error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Retrieve an IP
whitelabel // GET /whitelabel/ips/{id}</p>

<p>var request = sg.emptyRequest() request.method = &#39;GET&#39; request.path
= &#39;/v3/whitelabel/ips/{id}&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // Delete an IP
whitelabel // DELETE /whitelabel/ips/{id}</p>

<p>var request = sg.emptyRequest() request.method = &#39;DELETE&#39;
request.path = &#39;/v3/whitelabel/ips/{id}&#39; sg.API(request, function
(error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Validate an IP
whitelabel // POST /whitelabel/ips/{id}/validate</p>

<p>var request = sg.emptyRequest() request.method = &#39;POST&#39;
request.path = &#39;/v3/whitelabel/ips/{id}/validate&#39; sg.API(request,
function (error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Create a Link
Whitelabel // POST /whitelabel/links</p>
...
<p>}; <a href=""limit"">request.queryParams</a> = &#39;1&#39;</p>

<pre class="ruby"><span class="ruby-identifier">request</span>.<span class="ruby-identifier">queryParams</span>[<span class="ruby-string">&quot;offset&quot;</span>] = <span class="ruby-string">&#39;1&#39;</span>
</pre>

<p>request.method = &#39;POST&#39; request.path =
&#39;/v3/whitelabel/links&#39; sg.API(request, function (error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Retrieve all link
whitelabels // GET /whitelabel/links</p>

<p>var request = sg.emptyRequest() <a href=""limit"">request.queryParams</a> =
&#39;1&#39;</p>
...
<p>/////////////////////////////////////////////////// // Retrieve a Default
Link Whitelabel // GET /whitelabel/links/default</p>

<p>var request = sg.emptyRequest() <a href=""domain"">request.queryParams</a>
= &#39;test_string&#39;</p>

<p>request.method = &#39;GET&#39; request.path =
&#39;/v3/whitelabel/links/default&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // Retrieve Associated
Link Whitelabel // GET /whitelabel/links/subuser</p>

<p>var request = sg.emptyRequest() <a
href=""username"">request.queryParams</a> = &#39;test_string&#39;</p>

<p>request.method = &#39;GET&#39; request.path =
&#39;/v3/whitelabel/links/subuser&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // Disassociate a Link
Whitelabel // DELETE /whitelabel/links/subuser</p>

<p>var request = sg.emptyRequest() <a
href=""username"">request.queryParams</a> = &#39;test_string&#39;</p>

<p>request.method = &#39;DELETE&#39; request.path =
&#39;/v3/whitelabel/links/subuser&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // Update a Link
Whitelabel // PATCH /whitelabel/links/{id}</p>
...
<p>}; request.method = &#39;PATCH&#39; request.path =
&#39;/v3/whitelabel/links/{id}&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // Retrieve a Link
Whitelabel // GET /whitelabel/links/{id}</p>
...
<p>/////////////////////////////////////////////////// // Delete a Link
Whitelabel // DELETE /whitelabel/links/{id}</p>

<p>var request = sg.emptyRequest() request.method = &#39;DELETE&#39;
request.path = &#39;/v3/whitelabel/links/{id}&#39; sg.API(request, function
(error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Validate a Link
Whitelabel // POST /whitelabel/links/{id}/validate</p>

<p>var request = sg.emptyRequest() request.method = &#39;POST&#39;
request.path = &#39;/v3/whitelabel/links/{id}/validate&#39; sg.API(request,
function (error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Associate a Link
Whitelabel // POST /whitelabel/links/{link_id}/subuser</p>
...
<p>}; request.method = &#39;POST&#39; request.path =
&#39;/v3/whitelabel/links/{link_id}/subuser&#39; sg.API(request, function
(error, response) {</p>
