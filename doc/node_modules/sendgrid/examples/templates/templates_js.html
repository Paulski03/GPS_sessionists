...
<title>templates.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/sendgrid/examples/templates/templates.js">

<p>var sg = require(&#39;sendgrid&#39;)(process.env.SENDGRID_API_KEY)</p>

<p>/////////////////////////////////////////////////// // Create a
transactional template. // POST /templates</p>

<p>var request = sg.emptyRequest() request.body = {</p>

<pre>&quot;name&quot;: &quot;example_name&quot;</pre>

<p>}; request.method = &#39;POST&#39; request.path = &#39;/v3/templates&#39;
...
<p>/////////////////////////////////////////////////// // Retrieve all
transactional templates. // GET /templates</p>

<p>var request = sg.emptyRequest() request.method = &#39;GET&#39; request.path
= &#39;/v3/templates&#39; sg.API(request, function (error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Edit a transactional
template. // PATCH /templates/{template_id}</p>

<p>var request = sg.emptyRequest() request.body = {</p>

<pre>&quot;name&quot;: &quot;new_example_name&quot;</pre>

<p>}; request.method = &#39;PATCH&#39; request.path =
&#39;/v3/templates/{template_id}&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // Retrieve a single
transactional template. // GET /templates/{template_id}</p>
...
<p>/////////////////////////////////////////////////// // Delete a template.
// DELETE /templates/{template_id}</p>

<p>var request = sg.emptyRequest() request.method = &#39;DELETE&#39;
request.path = &#39;/v3/templates/{template_id}&#39; sg.API(request,
...
<p>/////////////////////////////////////////////////// // Create a new
transactional template version. // POST /templates/{template_id}/versions</p>
...
&quot;plain_content&quot;: &quot;&lt;%body%&gt;&quot;, 
&quot;subject&quot;: &quot;&lt;%subject%&gt;&quot;, 
&quot;template_id&quot;: &quot;ddb96bbc-9b92-425e-8979-99464621b543&quot;</pre>

<p>}; request.method = &#39;POST&#39; request.path =
&#39;/v3/templates/{template_id}/versions&#39; sg.API(request, function
(error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Edit a transactional
template version. // PATCH /templates/{template_id}/versions/{version_id}</p>
...
<p>}; request.method = &#39;PATCH&#39; request.path =
&#39;/v3/templates/{template_id}/versions/{version_id}&#39; sg.API(request,
function (error, response) {</p>
...
transactional template version. // GET
/templates/{template_id}/versions/{version_id}</p>
...
<p>/////////////////////////////////////////////////// // Delete a
transactional template version. // DELETE
/templates/{template_id}/versions/{version_id}</p>
...
<p>/////////////////////////////////////////////////// // Activate a
transactional template version. // POST
/templates/{template_id}/versions/{version_id}/activate</p>
