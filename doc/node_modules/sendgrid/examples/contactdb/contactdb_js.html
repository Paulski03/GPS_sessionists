...
<title>contactdb.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/sendgrid/examples/contactdb/contactdb.js">

<p>var sg = require(&#39;sendgrid&#39;)(process.env.SENDGRID_API_KEY)</p>

<p>/////////////////////////////////////////////////// // Create a Custom
Field // POST /contactdb/custom_fields</p>
...
&#39;/v3/contactdb/custom_fields&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // Retrieve all custom
fields // GET /contactdb/custom_fields</p>
...
<p>/////////////////////////////////////////////////// // Retrieve a Custom
Field // GET /contactdb/custom_fields/{custom_field_id}</p>

<p>var request = sg.emptyRequest() request.method = &#39;GET&#39; request.path
= &#39;/v3/contactdb/custom_fields/{custom_field_id}&#39; sg.API(request,
...
<p>/////////////////////////////////////////////////// // Delete a Custom
Field // DELETE /contactdb/custom_fields/{custom_field_id}</p>
...
<p>/////////////////////////////////////////////////// // Create a List //
POST /contactdb/lists</p>

<p>var request = sg.emptyRequest() request.body = {</p>

<pre>&quot;name&quot;: &quot;your list name&quot;</pre>

<p>}; request.method = &#39;POST&#39; request.path =
&#39;/v3/contactdb/lists&#39; sg.API(request, function (error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Retrieve all lists
// GET /contactdb/lists</p>

<p>var request = sg.emptyRequest() request.method = &#39;GET&#39; request.path
= &#39;/v3/contactdb/lists&#39; sg.API(request, function (error, response)
{</p>
...
<p>/////////////////////////////////////////////////// // Delete Multiple
lists // DELETE /contactdb/lists</p>
...
<p>/////////////////////////////////////////////////// // Update a List //
PATCH /contactdb/lists/{list_id}</p>

<p>var request = sg.emptyRequest() request.body = {</p>

<pre>&quot;name&quot;: &quot;newlistname&quot;</pre>

<p>}; <a href=""list_id"">request.queryParams</a> = &#39;1&#39;</p>

<p>request.method = &#39;PATCH&#39; request.path =
&#39;/v3/contactdb/lists/{list_id}&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // Retrieve a single
list // GET /contactdb/lists/{list_id}</p>

<p>var request = sg.emptyRequest() <a href=""list_id"">request.queryParams</a>
= &#39;1&#39;</p>
...
<p>/////////////////////////////////////////////////// // Delete a List //
DELETE /contactdb/lists/{list_id}</p>

<p>var request = sg.emptyRequest() <a
href=""delete_contacts"">request.queryParams</a> = &#39;true&#39;</p>
...
<p>/////////////////////////////////////////////////// // Add Multiple
Recipients to a List // POST /contactdb/lists/{list_id}/recipients</p>
...
<p>]; request.method = &#39;POST&#39; request.path =
&#39;/v3/contactdb/lists/{list_id}/recipients&#39; sg.API(request, function
(error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Retrieve all
recipients on a List // GET /contactdb/lists/{list_id}/recipients</p>

<p>var request = sg.emptyRequest() <a href=""page"">request.queryParams</a> =
&#39;1&#39;</p>

<pre class="ruby"><span class="ruby-identifier">request</span>.<span class="ruby-identifier">queryParams</span>[<span class="ruby-string">&quot;page_size&quot;</span>] = <span class="ruby-string">&#39;1&#39;</span>
<span class="ruby-identifier">request</span>.<span class="ruby-identifier">queryParams</span>[<span class="ruby-string">&quot;list_id&quot;</span>] = <span class="ruby-string">&#39;1&#39;</span>
</pre>
...
<p>/////////////////////////////////////////////////// // Add a Single
Recipient to a List // POST
/contactdb/lists/{list_id}/recipients/{recipient_id}</p>
...
<p>/////////////////////////////////////////////////// // Delete a Single
Recipient from a Single List // DELETE
/contactdb/lists/{list_id}/recipients/{recipient_id}</p>

<p>var request = sg.emptyRequest() <a
href=""recipient_id"">request.queryParams</a> = &#39;1&#39;</p>

<pre class="ruby"><span class="ruby-identifier">request</span>.<span class="ruby-identifier">queryParams</span>[<span class="ruby-string">&quot;list_id&quot;</span>] = <span class="ruby-string">&#39;1&#39;</span>
</pre>
...
<p>/////////////////////////////////////////////////// // Update Recipient //
PATCH /contactdb/recipients</p>

<p>var request = sg.emptyRequest() request.body = [</p>

<pre class="ruby">{
  <span class="ruby-string">&quot;email&quot;</span><span class="ruby-operator">:</span> <span class="ruby-string">&quot;jones@example.com&quot;</span>, 
  <span class="ruby-string">&quot;first_name&quot;</span><span class="ruby-operator">:</span> <span class="ruby-string">&quot;Guy&quot;</span>, 
  <span class="ruby-string">&quot;last_name&quot;</span><span class="ruby-operator">:</span> <span class="ruby-string">&quot;Jones&quot;</span>
}
</pre>

<p>]; request.method = &#39;PATCH&#39; request.path =
&#39;/v3/contactdb/recipients&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // Retrieve recipients
// GET /contactdb/recipients</p>
...
<p>/////////////////////////////////////////////////// // Retrieve the count
of billable recipients // GET /contactdb/recipients/billable_count</p>

<p>var request = sg.emptyRequest() request.method = &#39;GET&#39; request.path
= &#39;/v3/contactdb/recipients/billable_count&#39; sg.API(request,
function (error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Retrieve a Count of
Recipients // GET /contactdb/recipients/count</p>

<p>var request = sg.emptyRequest() request.method = &#39;GET&#39; request.path
= &#39;/v3/contactdb/recipients/count&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // Retrieve recipients
matching search criteria // GET /contactdb/recipients/search</p>

<p>var request = sg.emptyRequest() <a
href=""{field_name}"">request.queryParams</a> = &#39;test_string&#39;</p>

<p>request.method = &#39;GET&#39; request.path =
&#39;/v3/contactdb/recipients/search&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // Retrieve a single
recipient // GET /contactdb/recipients/{recipient_id}</p>

<p>var request = sg.emptyRequest() request.method = &#39;GET&#39; request.path
= &#39;/v3/contactdb/recipients/{recipient_id}&#39; sg.API(request,
function (error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Delete a Recipient
// DELETE /contactdb/recipients/{recipient_id}</p>
...
<p>/////////////////////////////////////////////////// // Retrieve the lists
that a recipient is on // GET /contactdb/recipients/{recipient_id}/lists</p>

<p>var request = sg.emptyRequest() request.method = &#39;GET&#39; request.path
= &#39;/v3/contactdb/recipients/{recipient_id}/lists&#39; sg.API(request,
function (error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Retrieve reserved
fields // GET /contactdb/reserved_fields</p>

<p>var request = sg.emptyRequest() request.method = &#39;GET&#39; request.path
= &#39;/v3/contactdb/reserved_fields&#39; sg.API(request, function (error,
response) {</p>
...
&quot;list_id&quot;: 4, 
&quot;name&quot;: &quot;Last Name Miller&quot;</pre>

<p>}; request.method = &#39;POST&#39; request.path =
&#39;/v3/contactdb/segments&#39; sg.API(request, function (error, response)
{</p>
...
<p>/////////////////////////////////////////////////// // Retrieve all
segments // GET /contactdb/segments</p>

<p>var request = sg.emptyRequest() request.method = &#39;GET&#39; request.path
= &#39;/v3/contactdb/segments&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // Update a segment //
PATCH /contactdb/segments/{segment_id}</p>
...
&quot;list_id&quot;: 5, 
&quot;name&quot;: &quot;The Millers&quot;</pre>

<p>}; <a href=""segment_id"">request.queryParams</a> = &#39;test_string&#39;</p>

<p>request.method = &#39;PATCH&#39; request.path =
&#39;/v3/contactdb/segments/{segment_id}&#39; sg.API(request, function
(error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Retrieve a segment
// GET /contactdb/segments/{segment_id}</p>

<p>var request = sg.emptyRequest() <a
href=""segment_id"">request.queryParams</a> = &#39;1&#39;</p>
...
<p>/////////////////////////////////////////////////// // Delete a segment //
DELETE /contactdb/segments/{segment_id}</p>
...
<p>/////////////////////////////////////////////////// // Retrieve recipients
on a segment // GET /contactdb/segments/{segment_id}/recipients</p>
...
<p>request.method = &#39;GET&#39; request.path =
&#39;/v3/contactdb/segments/{segment_id}/recipients&#39; sg.API(request,
function (error, response) {</p>
