...
<title>mailboxproviders.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/sendgrid/examples/mailboxproviders/mailboxproviders.js">

<p>var sg = require(&#39;sendgrid&#39;)(process.env.SENDGRID_API_KEY)</p>

<p>/////////////////////////////////////////////////// // Retrieve email
statistics by mailbox provider. // GET /mailbox_providers/stats</p>

<p>var request = sg.emptyRequest() <a
href=""end_date"">request.queryParams</a> = &#39;2016-04-01&#39;</p>

<pre class="ruby"><span class="ruby-identifier">request</span>.<span class="ruby-identifier">queryParams</span>[<span class="ruby-string">&quot;mailbox_providers&quot;</span>] = <span class="ruby-string">&#39;test_string&#39;</span>
<span class="ruby-identifier">request</span>.<span class="ruby-identifier">queryParams</span>[<span class="ruby-string">&quot;aggregated_by&quot;</span>] = <span class="ruby-string">&#39;day&#39;</span>
...
&#39;/v3/mailbox_providers/stats&#39; sg.API(request, function (error,
response) {</p>
