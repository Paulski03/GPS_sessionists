...
<title>categories.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/sendgrid/examples/categories/categories.js">

<p>var sg = require(&#39;sendgrid&#39;)(process.env.SENDGRID_API_KEY)</p>

<p>/////////////////////////////////////////////////// // Retrieve all
categories // GET /categories</p>

<p>var request = sg.emptyRequest() <a
href=""category"">request.queryParams</a> = &#39;test_string&#39;</p>
...
<p>request.method = &#39;GET&#39; request.path = &#39;/v3/categories&#39;
...
<p>/////////////////////////////////////////////////// // Retrieve Email
Statistics for Categories // GET /categories/stats</p>
...
<span class="ruby-identifier">request</span>.<span class="ruby-identifier">queryParams</span>[<span class="ruby-string">&quot;categories&quot;</span>] = <span class="ruby-string">&#39;test_string&#39;</span>
</pre>

<p>request.method = &#39;GET&#39; request.path =
&#39;/v3/categories/stats&#39; sg.API(request, function (error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Retrieve sums of
email stats for each category [Needs: Stats object defined, has category
ID?] // GET /categories/stats/sums</p>
...
<p>request.method = &#39;GET&#39; request.path =
&#39;/v3/categories/stats/sums&#39; sg.API(request, function (error,
response) {</p>
