...
<title>suppression.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/sendgrid/examples/suppression/suppression.js">

<p>var sg = require(&#39;sendgrid&#39;)(process.env.SENDGRID_API_KEY)</p>

<p>/////////////////////////////////////////////////// // Retrieve all blocks
// GET /suppression/blocks</p>

<p>var request = sg.emptyRequest() <a
href=""start_time"">request.queryParams</a> = &#39;1&#39;</p>
...
<span class="ruby-identifier">request</span>.<span class="ruby-identifier">queryParams</span>[<span class="ruby-string">&quot;end_time&quot;</span>] = <span class="ruby-string">&#39;1&#39;</span>
...
&#39;/v3/suppression/blocks&#39; sg.API(request, function (error, response)
{</p>
...
<p>/////////////////////////////////////////////////// // Delete blocks //
DELETE /suppression/blocks</p>

<p>var request = sg.emptyRequest() request.body = {</p>

<pre>&quot;delete_all&quot;: false, 
&quot;emails&quot;: [
...
block // GET /suppression/blocks/{email}</p>

<p>var request = sg.emptyRequest() request.method = &#39;GET&#39; request.path
= &#39;/v3/suppression/blocks/{email}&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // Delete a specific
block // DELETE /suppression/blocks/{email}</p>

<p>var request = sg.emptyRequest() request.method = &#39;DELETE&#39;
request.path = &#39;/v3/suppression/blocks/{email}&#39; sg.API(request,
...
<p>/////////////////////////////////////////////////// // Retrieve all bounces
// GET /suppression/bounces</p>

<p>var request = sg.emptyRequest() <a
href=""start_time"">request.queryParams</a> = &#39;1&#39;</p>

<pre class="ruby"><span class="ruby-identifier">request</span>.<span class="ruby-identifier">queryParams</span>[<span class="ruby-string">&quot;end_time&quot;</span>] = <span class="ruby-string">&#39;1&#39;</span>
</pre>

<p>request.method = &#39;GET&#39; request.path =
&#39;/v3/suppression/bounces&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // Retrieve a Bounce //
GET /suppression/bounces/{email}</p>

<p>var request = sg.emptyRequest() request.method = &#39;GET&#39; request.path
= &#39;/v3/suppression/bounces/{email}&#39; sg.API(request, function
(error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Delete a bounce //
DELETE /suppression/bounces/{email}</p>

<p>var request = sg.emptyRequest() <a
href=""email_address"">request.queryParams</a> =
&#39;example@example.com&#39;</p>

<p>request.method = &#39;DELETE&#39; request.path =
&#39;/v3/suppression/bounces/{email}&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // Retrieve all invalid
emails // GET /suppression/invalid_emails</p>
...
<p>request.method = &#39;GET&#39; request.path =
&#39;/v3/suppression/invalid_emails&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // Delete invalid
emails // DELETE /suppression/invalid_emails</p>
...
<p>/////////////////////////////////////////////////// // Retrieve a specific
invalid email // GET /suppression/invalid_emails/{email}</p>

<p>var request = sg.emptyRequest() request.method = &#39;GET&#39; request.path
= &#39;/v3/suppression/invalid_emails/{email}&#39; sg.API(request, function
(error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Delete a specific
invalid email // DELETE /suppression/invalid_emails/{email}</p>
...
<p>/////////////////////////////////////////////////// // Retrieve a specific
spam report // GET /suppression/spam_report/{email}</p>

<p>var request = sg.emptyRequest() request.method = &#39;GET&#39; request.path
= &#39;/v3/suppression/spam_report/{email}&#39; sg.API(request, function
(error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Delete a specific
spam report // DELETE /suppression/spam_report/{email}</p>
...
<p>/////////////////////////////////////////////////// // Retrieve all spam
reports // GET /suppression/spam_reports</p>
...
<p>request.method = &#39;GET&#39; request.path =
&#39;/v3/suppression/spam_reports&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // Delete spam reports
// DELETE /suppression/spam_reports</p>
...
<p>/////////////////////////////////////////////////// // Retrieve all global
suppressions // GET /suppression/unsubscribes</p>
...
<p>request.method = &#39;GET&#39; request.path =
&#39;/v3/suppression/unsubscribes&#39; sg.API(request, function (error,
response) {</p>
