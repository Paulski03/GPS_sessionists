...
<title>campaigns.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/sendgrid/examples/campaigns/campaigns.js">
...
&quot;title&quot;: &quot;March Newsletter&quot;</pre>

<p>}; request.method = &#39;POST&#39; request.path = &#39;/v3/campaigns&#39;
...
<p>request.method = &#39;GET&#39; request.path = &#39;/v3/campaigns&#39;
sg.API(request, function (error, response) {</p>
...
&quot;title&quot;: &quot;May Newsletter&quot;</pre>

<p>}; request.method = &#39;PATCH&#39; request.path =
&#39;/v3/campaigns/{campaign_id}&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // Retrieve a single
campaign // GET /campaigns/{campaign_id}</p>
...
<p>/////////////////////////////////////////////////// // Delete a Campaign //
DELETE /campaigns/{campaign_id}</p>

<p>var request = sg.emptyRequest() request.method = &#39;DELETE&#39;
request.path = &#39;/v3/campaigns/{campaign_id}&#39; sg.API(request,
...
<p>/////////////////////////////////////////////////// // Update a Scheduled
Campaign // PATCH /campaigns/{campaign_id}/schedules</p>

<p>var request = sg.emptyRequest() request.body = {</p>

<pre>&quot;send_at&quot;: 1489451436</pre>

<p>}; request.method = &#39;PATCH&#39; request.path =
&#39;/v3/campaigns/{campaign_id}/schedules&#39; sg.API(request, function
(error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Schedule a Campaign
// POST /campaigns/{campaign_id}/schedules</p>

<p>var request = sg.emptyRequest() request.body = {</p>

<pre>&quot;send_at&quot;: 1489771528</pre>
...
<p>/////////////////////////////////////////////////// // View Scheduled Time
of a Campaign // GET /campaigns/{campaign_id}/schedules</p>
...
<p>/////////////////////////////////////////////////// // Unschedule a
Scheduled Campaign // DELETE /campaigns/{campaign_id}/schedules</p>
...
<p>/////////////////////////////////////////////////// // Send a Campaign //
POST /campaigns/{campaign_id}/schedules/now</p>
...
<p>/////////////////////////////////////////////////// // Send a Test Campaign
// POST /campaigns/{campaign_id}/schedules/test</p>

<p>var request = sg.emptyRequest() request.body = {</p>

<pre>&quot;to&quot;: &quot;your.email@example.com&quot;</pre>

<p>}; request.method = &#39;POST&#39; request.path =
&#39;/v3/campaigns/{campaign_id}/schedules/test&#39; sg.API(request,
function (error, response) {</p>
