...
<title>asm.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/sendgrid/examples/asm/asm.js">

<p>var sg = require(&#39;sendgrid&#39;)(process.env.SENDGRID_API_KEY)</p>

<p>/////////////////////////////////////////////////// // Create a new
suppression group // POST /asm/groups</p>

<p>var request = sg.emptyRequest() request.body = {</p>

<pre>&quot;description&quot;: &quot;Suggestions for products our users might like.&quot;, 
&quot;is_default&quot;: true, 
&quot;name&quot;: &quot;Product Suggestions&quot;</pre>

<p>}; request.method = &#39;POST&#39; request.path = &#39;/v3/asm/groups&#39;
...
about multiple suppression groups // GET /asm/groups</p>

<p>var request = sg.emptyRequest() <a href=""id"">request.queryParams</a> =
&#39;1&#39;</p>

<p>request.method = &#39;GET&#39; request.path = &#39;/v3/asm/groups&#39;
sg.API(request, function (error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Update a suppression
group. // PATCH /asm/groups/{group_id}</p>

<p>var request = sg.emptyRequest() request.body = {</p>

<pre>&quot;description&quot;: &quot;Suggestions for items our users might like.&quot;, 
&quot;id&quot;: 103, 
&quot;name&quot;: &quot;Item Suggestions&quot;</pre>

<p>}; request.method = &#39;PATCH&#39; request.path =
&#39;/v3/asm/groups/{group_id}&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // Get information on a
single suppression group. // GET /asm/groups/{group_id}</p>
...
<p>/////////////////////////////////////////////////// // Delete a suppression
group. // DELETE /asm/groups/{group_id}</p>

<p>var request = sg.emptyRequest() request.method = &#39;DELETE&#39;
request.path = &#39;/v3/asm/groups/{group_id}&#39; sg.API(request, function
(error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Add suppressions to
a suppression group // POST /asm/groups/{group_id}/suppressions</p>

<p>var request = sg.emptyRequest() request.body = {</p>

<pre>&quot;recipient_emails&quot;: [
  &quot;test1@example.com&quot;, 
  &quot;test2@example.com&quot;
]</pre>

<p>}; request.method = &#39;POST&#39; request.path =
&#39;/v3/asm/groups/{group_id}/suppressions&#39; sg.API(request, function
(error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Retrieve all
suppressions for a suppression group // GET
/asm/groups/{group_id}/suppressions</p>
...
<p>/////////////////////////////////////////////////// // Search for
suppressions within a group // POST
/asm/groups/{group_id}/suppressions/search</p>
...
<p>}; request.method = &#39;POST&#39; request.path =
&#39;/v3/asm/groups/{group_id}/suppressions/search&#39; sg.API(request,
...
<p>/////////////////////////////////////////////////// // Delete a suppression
from a suppression group // DELETE
/asm/groups/{group_id}/suppressions/{email}</p>
...
<p>/////////////////////////////////////////////////// // Retrieve all
suppressions // GET /asm/suppressions</p>

<p>var request = sg.emptyRequest() request.method = &#39;GET&#39; request.path
= &#39;/v3/asm/suppressions&#39; sg.API(request, function (error, response)
{</p>
...
<p>/////////////////////////////////////////////////// // Add recipient
addresses to the global suppression group. // POST /asm/suppressions/global</p>
...
<p>}; request.method = &#39;POST&#39; request.path =
&#39;/v3/asm/suppressions/global&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // Retrieve a Global
Suppression // GET /asm/suppressions/global/{email}</p>

<p>var request = sg.emptyRequest() request.method = &#39;GET&#39; request.path
= &#39;/v3/asm/suppressions/global/{email}&#39; sg.API(request, function
(error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Delete a Global
Suppression // DELETE /asm/suppressions/global/{email}</p>
...
<p>/////////////////////////////////////////////////// // Retrieve all
suppression groups for an email address // GET /asm/suppressions/{email}</p>

<p>var request = sg.emptyRequest() request.method = &#39;GET&#39; request.path
= &#39;/v3/asm/suppressions/{email}&#39; sg.API(request, function (error,
response) {</p>
