...
<title>accesssettings.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/sendgrid/examples/accesssettings/accesssettings.js">

<p>var sg = require(&#39;sendgrid&#39;)(process.env.SENDGRID_API_KEY)</p>

<p>/////////////////////////////////////////////////// // Retrieve all recent
access attempts // GET /access_settings/activity</p>

<p>var request = sg.emptyRequest() <a href=""limit"">request.queryParams</a> =
&#39;1&#39;</p>

<p>request.method = &#39;GET&#39; request.path =
&#39;/v3/access_settings/activity&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // Add one or more IPs
to the whitelist // POST /access_settings/whitelist</p>
...
&#39;/v3/access_settings/whitelist&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // Retrieve a list of
currently whitelisted IPs // GET /access_settings/whitelist</p>
...
IPs from the whitelist // DELETE /access_settings/whitelist</p>
...
whitelisted IP // GET /access_settings/whitelist/{rule_id}</p>

<p>var request = sg.emptyRequest() request.method = &#39;GET&#39; request.path
= &#39;/v3/access_settings/whitelist/{rule_id}&#39; sg.API(request,
...
<p>/////////////////////////////////////////////////// // Remove a specific IP
from the whitelist // DELETE /access_settings/whitelist/{rule_id}</p>
