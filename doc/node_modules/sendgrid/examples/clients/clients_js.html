...
<title>clients.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/sendgrid/examples/clients/clients.js">

<p>var sg = require(&#39;sendgrid&#39;)(process.env.SENDGRID_API_KEY)</p>

<p>/////////////////////////////////////////////////// // Retrieve email
statistics by client type. // GET /clients/stats</p>

<p>var request = sg.emptyRequest() <a
href=""aggregated_by"">request.queryParams</a> = &#39;day&#39;</p>

<pre class="ruby"><span class="ruby-identifier">request</span>.<span class="ruby-identifier">queryParams</span>[<span class="ruby-string">&quot;start_date&quot;</span>] = <span class="ruby-string">&#39;2016-01-01&#39;</span>
...
<p>request.method = &#39;GET&#39; request.path = &#39;/v3/clients/stats&#39;
...
<p>/////////////////////////////////////////////////// // Retrieve stats by a
specific client type. // GET /clients/{client_type}/stats</p>
...
&#39;/v3/clients/{client_type}/stats&#39; sg.API(request, function (error,
response) {</p>
