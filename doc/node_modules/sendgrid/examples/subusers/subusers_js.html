...
<title>subusers.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/sendgrid/examples/subusers/subusers.js">
...
<p>}; request.method = &#39;POST&#39; request.path = &#39;/v3/subusers&#39;
...
<p>request.method = &#39;GET&#39; request.path = &#39;/v3/subusers&#39;
sg.API(request, function (error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Retrieve Subuser
Reputations // GET /subusers/reputations</p>

<p>var request = sg.emptyRequest() <a
href=""usernames"">request.queryParams</a> = &#39;test_string&#39;</p>

<p>request.method = &#39;GET&#39; request.path =
&#39;/v3/subusers/reputations&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // Retrieve email
statistics for your subusers. // GET /subusers/stats</p>

<p>var request = sg.emptyRequest() <a
href=""end_date"">request.queryParams</a> = &#39;2016-04-01&#39;</p>

<pre class="ruby"><span class="ruby-identifier">request</span>.<span class="ruby-identifier">queryParams</span>[<span class="ruby-string">&quot;aggregated_by&quot;</span>] = <span class="ruby-string">&#39;day&#39;</span>
...
<span class="ruby-identifier">request</span>.<span class="ruby-identifier">queryParams</span>[<span class="ruby-string">&quot;offset&quot;</span>] = <span class="ruby-string">&#39;1&#39;</span>
<span class="ruby-identifier">request</span>.<span class="ruby-identifier">queryParams</span>[<span class="ruby-string">&quot;start_date&quot;</span>] = <span class="ruby-string">&#39;2016-01-01&#39;</span>
<span class="ruby-identifier">request</span>.<span class="ruby-identifier">queryParams</span>[<span class="ruby-string">&quot;subusers&quot;</span>] = <span class="ruby-string">&#39;test_string&#39;</span>
</pre>

<p>request.method = &#39;GET&#39; request.path = &#39;/v3/subusers/stats&#39;
sg.API(request, function (error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Retrieve monthly
stats for all subusers // GET /subusers/stats/monthly</p>

<p>var request = sg.emptyRequest() <a href=""subuser"">request.queryParams</a>
= &#39;test_string&#39;</p>

<pre class="ruby"><span class="ruby-identifier">request</span>.<span class="ruby-identifier">queryParams</span>[<span class="ruby-string">&quot;limit&quot;</span>] = <span class="ruby-string">&#39;1&#39;</span>
<span class="ruby-identifier">request</span>.<span class="ruby-identifier">queryParams</span>[<span class="ruby-string">&quot;sort_by_metric&quot;</span>] = <span class="ruby-string">&#39;test_string&#39;</span>
<span class="ruby-identifier">request</span>.<span class="ruby-identifier">queryParams</span>[<span class="ruby-string">&quot;offset&quot;</span>] = <span class="ruby-string">&#39;1&#39;</span>
<span class="ruby-identifier">request</span>.<span class="ruby-identifier">queryParams</span>[<span class="ruby-string">&quot;date&quot;</span>] = <span class="ruby-string">&#39;test_string&#39;</span>
<span class="ruby-identifier">request</span>.<span class="ruby-identifier">queryParams</span>[<span class="ruby-string">&quot;sort_by_direction&quot;</span>] = <span class="ruby-string">&#39;asc&#39;</span>
</pre>

<p>request.method = &#39;GET&#39; request.path =
&#39;/v3/subusers/stats/monthly&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// //  Retrieve the totals
for each email statistic metric for all subusers. // GET
/subusers/stats/sums</p>
...
<p>request.method = &#39;GET&#39; request.path =
&#39;/v3/subusers/stats/sums&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // Enable/disable a
subuser // PATCH /subusers/{subuser_name}</p>
...
&#39;/v3/subusers/{subuser_name}&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // Delete a subuser //
DELETE /subusers/{subuser_name}</p>

<p>var request = sg.emptyRequest() request.method = &#39;DELETE&#39;
request.path = &#39;/v3/subusers/{subuser_name}&#39; sg.API(request,
...
<p>/////////////////////////////////////////////////// // Update IPs assigned
to a subuser // PUT /subusers/{subuser_name}/ips</p>

<p>var request = sg.emptyRequest() request.body = [</p>

<pre class="ruby"><span class="ruby-string">&quot;127.0.0.1&quot;</span>
</pre>

<p>]; request.method = &#39;PUT&#39; request.path =
&#39;/v3/subusers/{subuser_name}/ips&#39; sg.API(request, function (error,
response) {</p>
...
<p>/////////////////////////////////////////////////// // Update Monitor
Settings for a subuser // PUT /subusers/{subuser_name}/monitor</p>

<p>var request = sg.emptyRequest() request.body = {</p>

<pre>&quot;email&quot;: &quot;example@example.com&quot;, 
&quot;frequency&quot;: 500</pre>

<p>}; request.method = &#39;PUT&#39; request.path =
&#39;/v3/subusers/{subuser_name}/monitor&#39; sg.API(request, function
(error, response) {</p>
...
<p>/////////////////////////////////////////////////// // Create monitor
settings // POST /subusers/{subuser_name}/monitor</p>
...
<p>/////////////////////////////////////////////////// // Retrieve monitor
settings for a subuser // GET /subusers/{subuser_name}/monitor</p>
...
<p>/////////////////////////////////////////////////// // Delete monitor
settings // DELETE /subusers/{subuser_name}/monitor</p>
...
<p>/////////////////////////////////////////////////// // Retrieve the monthly
email statistics for a single subuser // GET
/subusers/{subuser_name}/stats/monthly</p>

<p>var request = sg.emptyRequest() <a href=""date"">request.queryParams</a> =
&#39;test_string&#39;</p>

<pre class="ruby"><span class="ruby-identifier">request</span>.<span class="ruby-identifier">queryParams</span>[<span class="ruby-string">&quot;sort_by_direction&quot;</span>] = <span class="ruby-string">&#39;asc&#39;</span>
<span class="ruby-identifier">request</span>.<span class="ruby-identifier">queryParams</span>[<span class="ruby-string">&quot;limit&quot;</span>] = <span class="ruby-string">&#39;1&#39;</span>
<span class="ruby-identifier">request</span>.<span class="ruby-identifier">queryParams</span>[<span class="ruby-string">&quot;sort_by_metric&quot;</span>] = <span class="ruby-string">&#39;test_string&#39;</span>
<span class="ruby-identifier">request</span>.<span class="ruby-identifier">queryParams</span>[<span class="ruby-string">&quot;offset&quot;</span>] = <span class="ruby-string">&#39;1&#39;</span>
</pre>
...
<p>request.method = &#39;GET&#39; request.path =
&#39;/v3/subusers/{subuser_name}/stats/monthly&#39; sg.API(request,
function (error, response) {</p>
