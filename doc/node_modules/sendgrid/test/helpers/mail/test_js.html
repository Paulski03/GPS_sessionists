...
<main role="main" aria-label="Page node_modules/sendgrid/test/helpers/mail/test.js">

<p>var assert = require(&#39;chai&#39;).assert</p>

<p>// Test the minimum required to send an email
describe(&#39;helloEmail&#39;, function () {</p>

<pre>var helper = require(&#39;../../../lib/helpers/mail/mail.js&#39;)
...
<p>// Test a fully loaded email payload describe(&#39;kitchenSink&#39;,
function () {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">helper</span> = <span class="ruby-identifier">require</span>(<span class="ruby-string">&#39;../../../lib/helpers/mail/mail.js&#39;</span>)

<span class="ruby-identifier">mail</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">Mail</span>()
<span class="ruby-identifier">email</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">Email</span>(<span class="ruby-string">&quot;test@example.com&quot;</span>, <span class="ruby-string">&quot;Example User&quot;</span>)
<span class="ruby-identifier">mail</span>.<span class="ruby-identifier">setFrom</span>(<span class="ruby-identifier">email</span>)

<span class="ruby-identifier">mail</span>.<span class="ruby-identifier">setSubject</span>(<span class="ruby-string">&quot;Hello World from the SendGrid Node.js Library&quot;</span>)

<span class="ruby-identifier">personalization</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">Personalization</span>()
<span class="ruby-identifier">email</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">Email</span>(<span class="ruby-string">&quot;test@example.com&quot;</span>, <span class="ruby-string">&quot;Example User&quot;</span>)
<span class="ruby-identifier">personalization</span>.<span class="ruby-identifier">addTo</span>(<span class="ruby-identifier">email</span>)
<span class="ruby-identifier">email</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">Email</span>(<span class="ruby-string">&quot;test@example.com&quot;</span>, <span class="ruby-string">&quot;Example User&quot;</span>)
<span class="ruby-identifier">personalization</span>.<span class="ruby-identifier">addTo</span>(<span class="ruby-identifier">email</span>)
<span class="ruby-identifier">email</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">Email</span>(<span class="ruby-string">&quot;test@example.com&quot;</span>, <span class="ruby-string">&quot;Example User&quot;</span>)
<span class="ruby-identifier">personalization</span>.<span class="ruby-identifier">addCc</span>(<span class="ruby-identifier">email</span>)
<span class="ruby-identifier">email</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">Email</span>(<span class="ruby-string">&quot;test@example.com&quot;</span>, <span class="ruby-string">&quot;Example User&quot;</span>)
<span class="ruby-identifier">personalization</span>.<span class="ruby-identifier">addCc</span>(<span class="ruby-identifier">email</span>)
<span class="ruby-identifier">email</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">Email</span>(<span class="ruby-string">&quot;test@example.com&quot;</span>, <span class="ruby-string">&quot;Example User&quot;</span>)
<span class="ruby-identifier">personalization</span>.<span class="ruby-identifier">addBcc</span>(<span class="ruby-identifier">email</span>)
<span class="ruby-identifier">email</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">Email</span>(<span class="ruby-string">&quot;test@example.com&quot;</span>, <span class="ruby-string">&quot;Example User&quot;</span>)
<span class="ruby-identifier">personalization</span>.<span class="ruby-identifier">addBcc</span>(<span class="ruby-identifier">email</span>)
<span class="ruby-identifier">personalization</span>.<span class="ruby-identifier">setSubject</span>(<span class="ruby-string">&quot;Hello World from the Personalized SendGrid Node.js Library&quot;</span>)
<span class="ruby-identifier">header</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">Header</span>(<span class="ruby-string">&quot;X-Test&quot;</span>, <span class="ruby-string">&quot;True&quot;</span>)
<span class="ruby-identifier">personalization</span>.<span class="ruby-identifier">addHeader</span>(<span class="ruby-identifier">header</span>)
<span class="ruby-identifier">header</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">Header</span>(<span class="ruby-string">&quot;X-Test2&quot;</span>, <span class="ruby-string">&quot;False&quot;</span>)
<span class="ruby-identifier">personalization</span>.<span class="ruby-identifier">addHeader</span>(<span class="ruby-identifier">header</span>)
<span class="ruby-identifier">substitution</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">Substitution</span>(<span class="ruby-string">&quot;%name%&quot;</span>, <span class="ruby-string">&quot;Example User&quot;</span>)
<span class="ruby-identifier">personalization</span>.<span class="ruby-identifier">addSubstitution</span>(<span class="ruby-identifier">substitution</span>)
<span class="ruby-identifier">substitution</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">Substitution</span>(<span class="ruby-string">&quot;%city%&quot;</span>, <span class="ruby-string">&quot;Denver&quot;</span>)
<span class="ruby-identifier">personalization</span>.<span class="ruby-identifier">addSubstitution</span>(<span class="ruby-identifier">substitution</span>)
<span class="ruby-identifier">custom_arg</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">CustomArgs</span>(<span class="ruby-string">&quot;timing&quot;</span>, <span class="ruby-string">&quot;morning&quot;</span>)
<span class="ruby-identifier">personalization</span>.<span class="ruby-identifier">addCustomArg</span>(<span class="ruby-identifier">custom_arg</span>)
<span class="ruby-identifier">custom_arg</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">CustomArgs</span>(<span class="ruby-string">&quot;type&quot;</span>, <span class="ruby-string">&quot;marketing&quot;</span>)
<span class="ruby-identifier">personalization</span>.<span class="ruby-identifier">addCustomArg</span>(<span class="ruby-identifier">custom_arg</span>)
<span class="ruby-identifier">personalization</span>.<span class="ruby-identifier">setSendAt</span>(<span class="ruby-value">1443636899</span>)
<span class="ruby-identifier">mail</span>.<span class="ruby-identifier">addPersonalization</span>(<span class="ruby-identifier">personalization</span>)

<span class="ruby-identifier">content</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">Content</span>(<span class="ruby-string">&quot;text/plain&quot;</span>, <span class="ruby-string">&quot;some text here&quot;</span>)
<span class="ruby-identifier">mail</span>.<span class="ruby-identifier">addContent</span>(<span class="ruby-identifier">content</span>)
<span class="ruby-identifier">content</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">Content</span>(<span class="ruby-string">&quot;text/html&quot;</span>, <span class="ruby-string">&quot;&lt;html&gt;&lt;body&gt;some text here&lt;/body&gt;&lt;/html&gt;&quot;</span>)
<span class="ruby-identifier">mail</span>.<span class="ruby-identifier">addContent</span>(<span class="ruby-identifier">content</span>)
<span class="ruby-identifier">content</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">Content</span>(<span class="ruby-string">&quot;text/calendar&quot;</span>, <span class="ruby-string">&quot;Party Time&quot;</span>)
<span class="ruby-identifier">mail</span>.<span class="ruby-identifier">addContent</span>(<span class="ruby-identifier">content</span>)

<span class="ruby-identifier">attachment</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">Attachment</span>()
<span class="ruby-identifier">attachment</span>.<span class="ruby-identifier">setContent</span>(<span class="ruby-string">&quot;TG9yZW0gaXBzdW0gZG9sb3Igc2l0IGFtZXQsIGNvbnNlY3RldHVyIGFkaXBpc2NpbmcgZWxpdC4gQ3JhcyBwdW12&quot;</span>)
<span class="ruby-identifier">attachment</span>.<span class="ruby-identifier">setType</span>(<span class="ruby-string">&quot;application/pdf&quot;</span>)
<span class="ruby-identifier">attachment</span>.<span class="ruby-identifier">setFilename</span>(<span class="ruby-string">&quot;balance_001.pdf&quot;</span>)
<span class="ruby-identifier">attachment</span>.<span class="ruby-identifier">setDisposition</span>(<span class="ruby-string">&quot;attachment&quot;</span>)
<span class="ruby-identifier">mail</span>.<span class="ruby-identifier">addAttachment</span>(<span class="ruby-identifier">attachment</span>)

<span class="ruby-identifier">attachment</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">Attachment</span>()
<span class="ruby-identifier">attachment</span>.<span class="ruby-identifier">setContent</span>(<span class="ruby-string">&quot;BwdW&quot;</span>)
<span class="ruby-identifier">attachment</span>.<span class="ruby-identifier">setType</span>(<span class="ruby-string">&quot;image/png&quot;</span>)
<span class="ruby-identifier">attachment</span>.<span class="ruby-identifier">setFilename</span>(<span class="ruby-string">&quot;banner.png&quot;</span>)
<span class="ruby-identifier">attachment</span>.<span class="ruby-identifier">setDisposition</span>(<span class="ruby-string">&quot;inline&quot;</span>)
<span class="ruby-identifier">attachment</span>.<span class="ruby-identifier">setContentId</span>(<span class="ruby-string">&quot;banner&quot;</span>)
<span class="ruby-identifier">mail</span>.<span class="ruby-identifier">addAttachment</span>(<span class="ruby-identifier">attachment</span>)

<span class="ruby-identifier">mail</span>.<span class="ruby-identifier">setTemplateId</span>(<span class="ruby-string">&quot;439b6d66-4408-4ead-83de-5c83c2ee313a&quot;</span>)

<span class="ruby-identifier">section</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">Section</span>(<span class="ruby-string">&quot;%section1%&quot;</span>, <span class="ruby-string">&quot;Textforasubstitutiontagofsection1&quot;</span>)
<span class="ruby-identifier">mail</span>.<span class="ruby-identifier">addSection</span>(<span class="ruby-identifier">section</span>)
<span class="ruby-identifier">section</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">Section</span>(<span class="ruby-string">&quot;%section2%&quot;</span>, <span class="ruby-string">&quot;Textforasubstitutiontagofsection2&quot;</span>)
<span class="ruby-identifier">mail</span>.<span class="ruby-identifier">addSection</span>(<span class="ruby-identifier">section</span>)

<span class="ruby-identifier">header</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">Header</span>(<span class="ruby-string">&quot;X-Test3&quot;</span>, <span class="ruby-string">&quot;1&quot;</span>)
<span class="ruby-identifier">mail</span>.<span class="ruby-identifier">addHeader</span>(<span class="ruby-identifier">header</span>)
<span class="ruby-identifier">header</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">Header</span>(<span class="ruby-string">&quot;X-Test4&quot;</span>, <span class="ruby-string">&quot;2&quot;</span>)
<span class="ruby-identifier">mail</span>.<span class="ruby-identifier">addHeader</span>(<span class="ruby-identifier">header</span>)

<span class="ruby-identifier">category</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">Category</span>(<span class="ruby-string">&quot;January&quot;</span>)
<span class="ruby-identifier">mail</span>.<span class="ruby-identifier">addCategory</span>(<span class="ruby-identifier">category</span>)
<span class="ruby-identifier">category</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">Category</span>(<span class="ruby-string">&quot;2015&quot;</span>)
<span class="ruby-identifier">mail</span>.<span class="ruby-identifier">addCategory</span>(<span class="ruby-identifier">category</span>)

<span class="ruby-identifier">custom_arg</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">CustomArgs</span>(<span class="ruby-string">&quot;timing&quot;</span>, <span class="ruby-string">&quot;evening&quot;</span>)
<span class="ruby-identifier">mail</span>.<span class="ruby-identifier">addCustomArg</span>(<span class="ruby-identifier">custom_arg</span>)
<span class="ruby-identifier">custom_arg</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">CustomArgs</span>(<span class="ruby-string">&quot;type&quot;</span>, <span class="ruby-string">&quot;summer_contest&quot;</span>)
<span class="ruby-identifier">mail</span>.<span class="ruby-identifier">addCustomArg</span>(<span class="ruby-identifier">custom_arg</span>)

<span class="ruby-identifier">mail</span>.<span class="ruby-identifier">setSendAt</span>(<span class="ruby-value">1443636899</span>)

<span class="ruby-identifier">mail</span>.<span class="ruby-identifier">setBatchId</span>(<span class="ruby-string">&quot;some_batch_id&quot;</span>)

<span class="ruby-identifier">asm</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">Asm</span>(<span class="ruby-value">3</span>, [<span class="ruby-value">1</span>,<span class="ruby-value">4</span>,<span class="ruby-value">5</span>])
<span class="ruby-identifier">mail</span>.<span class="ruby-identifier">setAsm</span>(<span class="ruby-identifier">asm</span>)

<span class="ruby-identifier">mail</span>.<span class="ruby-identifier">setIpPoolName</span>(<span class="ruby-string">&quot;23&quot;</span>)

<span class="ruby-identifier">mail_settings</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">MailSettings</span>()
<span class="ruby-identifier">bcc</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">Bcc</span>(<span class="ruby-keyword">true</span>, <span class="ruby-string">&quot;test@example.com&quot;</span>)
<span class="ruby-identifier">mail_settings</span>.<span class="ruby-identifier">setBcc</span>(<span class="ruby-identifier">bcc</span>)
<span class="ruby-identifier">footer</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">Footer</span>(<span class="ruby-keyword">true</span>, <span class="ruby-string">&quot;some footer text&quot;</span>, <span class="ruby-string">&quot;&lt;html&gt;&lt;body&gt;some footer text&lt;/body&gt;&lt;/html&gt;&quot;</span>)
<span class="ruby-identifier">mail_settings</span>.<span class="ruby-identifier">setFooter</span>(<span class="ruby-identifier">footer</span>)
<span class="ruby-identifier">sandbox_mode</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">SandBoxMode</span>(<span class="ruby-keyword">true</span>)
<span class="ruby-identifier">mail_settings</span>.<span class="ruby-identifier">setSandBoxMode</span>(<span class="ruby-identifier">sandbox_mode</span>)
<span class="ruby-identifier">spam_check</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">SpamCheck</span>(<span class="ruby-keyword">true</span>, <span class="ruby-value">1</span>, <span class="ruby-string">&quot;https://gotchya.example.com&quot;</span>)
<span class="ruby-identifier">mail_settings</span>.<span class="ruby-identifier">setSpamCheck</span>(<span class="ruby-identifier">spam_check</span>)
<span class="ruby-identifier">bypass_list_management</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">BypassListManagement</span>(<span class="ruby-keyword">true</span>);
<span class="ruby-identifier">mail_settings</span>.<span class="ruby-identifier">setBypassListManagement</span>(<span class="ruby-identifier">bypass_list_management</span>);
<span class="ruby-identifier">mail</span>.<span class="ruby-identifier">addMailSettings</span>(<span class="ruby-identifier">mail_settings</span>)

<span class="ruby-identifier">tracking_settings</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">TrackingSettings</span>()
<span class="ruby-identifier">click_tracking</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">ClickTracking</span>(<span class="ruby-keyword">false</span>, <span class="ruby-keyword">false</span>)
<span class="ruby-identifier">tracking_settings</span>.<span class="ruby-identifier">setClickTracking</span>(<span class="ruby-identifier">click_tracking</span>)
<span class="ruby-identifier">open_tracking</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">OpenTracking</span>(<span class="ruby-keyword">true</span>, <span class="ruby-string">&quot;Optional tag to replace with the open image in the body of the message&quot;</span>)
<span class="ruby-identifier">tracking_settings</span>.<span class="ruby-identifier">setOpenTracking</span>(<span class="ruby-identifier">open_tracking</span>)
<span class="ruby-identifier">subscription_tracking</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">SubscriptionTracking</span>(<span class="ruby-keyword">true</span>, <span class="ruby-string">&quot;text to insert into the text/plain portion of the message&quot;</span>, <span class="ruby-string">&quot;html to insert into the text/html portion of the message&quot;</span>, <span class="ruby-string">&quot;Optional tag to replace with the open image in the body of the message&quot;</span>)
<span class="ruby-identifier">tracking_settings</span>.<span class="ruby-identifier">setSubscriptionTracking</span>(<span class="ruby-identifier">subscription_tracking</span>)
<span class="ruby-identifier">ganalytics</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">Ganalytics</span>(<span class="ruby-keyword">true</span>, <span class="ruby-string">&quot;some utm source&quot;</span>, <span class="ruby-string">&quot;some utc medium&quot;</span>, <span class="ruby-string">&quot;some utm term&quot;</span>, <span class="ruby-string">&quot;some utm content&quot;</span>, <span class="ruby-string">&quot;some utm campaign&quot;</span>)
<span class="ruby-identifier">tracking_settings</span>.<span class="ruby-identifier">setGanalytics</span>(<span class="ruby-identifier">ganalytics</span>)
<span class="ruby-identifier">mail</span>.<span class="ruby-identifier">addTrackingSettings</span>(<span class="ruby-identifier">tracking_settings</span>)

<span class="ruby-identifier">email</span> = <span class="ruby-identifier">new</span> <span class="ruby-identifier">helper</span>.<span class="ruby-constant">Email</span>(<span class="ruby-string">&quot;test@example.com&quot;</span>, <span class="ruby-string">&quot;Example User&quot;</span>)
<span class="ruby-identifier">mail</span>.<span class="ruby-identifier">setReplyTo</span>(<span class="ruby-identifier">email</span>)

<span class="ruby-identifier">test_payload</span> = <span class="ruby-string">&#39;{&quot;from&quot;:{&quot;email&quot;:&quot;test@example.com&quot;,&quot;name&quot;:&quot;Example User&quot;},&quot;personalizations&quot;:[{&quot;to&quot;:[{&quot;email&quot;:&quot;test@example.com&quot;,&quot;name&quot;:&quot;Example User&quot;},{&quot;email&quot;:&quot;test@example.com&quot;,&quot;name&quot;:&quot;Example User&quot;}],&quot;cc&quot;:[{&quot;email&quot;:&quot;test@example.com&quot;,&quot;name&quot;:&quot;Example User&quot;},{&quot;email&quot;:&quot;test@example.com&quot;,&quot;name&quot;:&quot;Example User&quot;}],&quot;bcc&quot;:[{&quot;email&quot;:&quot;test@example.com&quot;,&quot;name&quot;:&quot;Example User&quot;},{&quot;email&quot;:&quot;test@example.com&quot;,&quot;name&quot;:&quot;Example User&quot;}],&quot;subject&quot;:&quot;Hello World from the Personalized SendGrid Node.js Library&quot;,&quot;headers&quot;:{&quot;X-Test&quot;:&quot;True&quot;,&quot;X-Test2&quot;:&quot;False&quot;},&quot;substitutions&quot;:{&quot;%name%&quot;:&quot;Example User&quot;,&quot;%city%&quot;:&quot;Denver&quot;},&quot;custom_args&quot;:{&quot;timing&quot;:&quot;morning&quot;,&quot;type&quot;:&quot;marketing&quot;},&quot;send_at&quot;:1443636899}],&quot;subject&quot;:&quot;Hello World from the SendGrid Node.js Library&quot;,&quot;content&quot;:[{&quot;type&quot;:&quot;text/plain&quot;,&quot;value&quot;:&quot;some text here&quot;},{&quot;type&quot;:&quot;text/html&quot;,&quot;value&quot;:&quot;&lt;html&gt;&lt;body&gt;some text here&lt;/body&gt;&lt;/html&gt;&quot;},{&quot;type&quot;:&quot;text/calendar&quot;,&quot;value&quot;:&quot;Party Time&quot;}],&quot;attachments&quot;:[{&quot;content&quot;:&quot;TG9yZW0gaXBzdW0gZG9sb3Igc2l0IGFtZXQsIGNvbnNlY3RldHVyIGFkaXBpc2NpbmcgZWxpdC4gQ3JhcyBwdW12&quot;,&quot;type&quot;:&quot;application/pdf&quot;,&quot;filename&quot;:&quot;balance_001.pdf&quot;,&quot;disposition&quot;:&quot;attachment&quot;},{&quot;content&quot;:&quot;BwdW&quot;,&quot;type&quot;:&quot;image/png&quot;,&quot;filename&quot;:&quot;banner.png&quot;,&quot;disposition&quot;:&quot;inline&quot;,&quot;content_id&quot;:&quot;banner&quot;}],&quot;template_id&quot;:&quot;439b6d66-4408-4ead-83de-5c83c2ee313a&quot;,&quot;sections&quot;:{&quot;%section1%&quot;:&quot;Textforasubstitutiontagofsection1&quot;,&quot;%section2%&quot;:&quot;Textforasubstitutiontagofsection2&quot;},&quot;headers&quot;:{&quot;X-Test3&quot;:&quot;1&quot;,&quot;X-Test4&quot;:&quot;2&quot;},&quot;categories&quot;:[&quot;January&quot;,&quot;2015&quot;],&quot;custom_args&quot;:{&quot;timing&quot;:&quot;evening&quot;,&quot;type&quot;:&quot;summer_contest&quot;},&quot;send_at&quot;:1443636899,&quot;batch_id&quot;:&quot;some_batch_id&quot;,&quot;asm&quot;:{&quot;group_id&quot;:3,&quot;groups_to_display&quot;:[1,4,5]},&quot;ip_pool_name&quot;:&quot;23&quot;,&quot;mail_settings&quot;:{&quot;bcc&quot;:{&quot;enable&quot;:true,&quot;email&quot;:&quot;test@example.com&quot;},&quot;bypass_list_management&quot;:{&quot;enable&quot;:true},&quot;footer&quot;:{&quot;enable&quot;:true,&quot;text&quot;:&quot;some footer text&quot;,&quot;html&quot;:&quot;&lt;html&gt;&lt;body&gt;some footer text&lt;/body&gt;&lt;/html&gt;&quot;},&quot;sandbox_mode&quot;:{&quot;enable&quot;:true},&quot;spam_check&quot;:{&quot;enable&quot;:true,&quot;threshold&quot;:1,&quot;post_to_url&quot;:&quot;https://gotchya.example.com&quot;}},&quot;tracking_settings&quot;:{&quot;click_tracking&quot;:{&quot;enable&quot;:false,&quot;enable_text&quot;:false},&quot;open_tracking&quot;:{&quot;enable&quot;:true,&quot;substitution_tag&quot;:&quot;Optional tag to replace with the open image in the body of the message&quot;},&quot;subscription_tracking&quot;:{&quot;enable&quot;:true,&quot;text&quot;:&quot;text to insert into the text/plain portion of the message&quot;,&quot;html&quot;:&quot;html to insert into the text/html portion of the message&quot;,&quot;substitution_tag&quot;:&quot;Optional tag to replace with the open image in the body of the message&quot;},&quot;ganalytics&quot;:{&quot;enable&quot;:true,&quot;utm_source&quot;:&quot;some utm source&quot;,&quot;utm_medium&quot;:&quot;some utc medium&quot;,&quot;utm_term&quot;:&quot;some utm term&quot;,&quot;utm_content&quot;:&quot;some utm content&quot;,&quot;utm_campaign&quot;:&quot;some utm campaign&quot;}},&quot;reply_to&quot;:{&quot;email&quot;:&quot;test@example.com&quot;,&quot;name&quot;:&quot;Example User&quot;}}&#39;</span>

<span class="ruby-identifier">it</span>(<span class="ruby-string">&#39;builds the correct payload&#39;</span>, <span class="ruby-identifier">function</span>() {
    <span class="ruby-identifier">assert</span>.<span class="ruby-identifier">equal</span>(<span class="ruby-constant">JSON</span>.<span class="ruby-identifier">stringify</span>(<span class="ruby-identifier">mail</span>.<span class="ruby-identifier">toJSON</span>()), <span class="ruby-identifier">test_payload</span>, <span class="ruby-string">&#39;payload is correct&#39;</span>)
});
</pre>
