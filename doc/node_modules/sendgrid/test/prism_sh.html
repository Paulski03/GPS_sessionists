...
<title>prism.sh - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/sendgrid/test/prism.sh">
...
<p>UNAME=$(uname) ARCH=$(uname -m) if [ “$UNAME” != “Linux” ] &amp;&amp; [
“$UNAME” != “Darwin” ] &amp;&amp; [ “$ARCH” != “x86_64” ] &amp;&amp; [
“$ARCH” != “i686” ]; then</p>

<pre class="ruby"><span class="ruby-identifier">echo</span> <span class="ruby-string">&quot;Sorry, OS/Architecture not supported: ${UNAME}/${ARCH}. Download binary from https://github.com/stoplightio/prism/releases&quot;</span>
<span class="ruby-identifier">exit</span> <span class="ruby-value">1</span>
</pre>

<p>fi</p>

<p>if [ “$UNAME” = “Darwin” ] ; then</p>

<pre>OSX_ARCH=$(uname -m)
if [ &quot;${OSX_ARCH}&quot; = &quot;x86_64&quot; ] ; then
  PLATFORM=&quot;darwin_amd64&quot;
fi</pre>

<p>elif [ “$UNAME” = “Linux” ] ; then</p>

<pre>LINUX_ARCH=$(uname -m)
...
<p>#LATEST=$(curl -s <a
href="https://api.github.com/repos/stoplightio/prism/tags">api.github.com/repos/stoplightio/prism/tags</a>
| grep -Eo &#39;“<a href="^\\">name”:.*?</a>“,&#39;  | head -n 1 | sed
&#39;s/[,” ]//g&#39; | cut -d &#39;:&#39; -f 2) LATEST=“v0.1.5” URL=“<a
href="https://github.com/stoplightio/prism/releases/download/$LATEST/prism_$PLATFORM">github.com/stoplightio/prism/releases/download/$LATEST/prism_$PLATFORM</a>”
DEST=./prism/bin/prism</p>

<p>if [ -z $LATEST ] ; then</p>

<pre class="ruby"><span class="ruby-identifier">echo</span> <span class="ruby-string">&quot;Error requesting. Download binary from ${URL}&quot;</span>
<span class="ruby-identifier">exit</span> <span class="ruby-value">1</span>
</pre>

<p>else</p>

<pre>curl -L $URL -o $DEST
chmod +x $DEST</pre>
