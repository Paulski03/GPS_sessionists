...
<main role="main" aria-label="Page node_modules/sendgrid/lib/helpers/mail/README.md">

<p><strong>This helper allows you to quickly and easily build a Mail object
for sending email through SendGrid.</strong></p>

<h1 id="label-Quick+Start">Quick Start<span><a href="#label-Quick+Start">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p>Run the <a
href="https://github.com/sendgrid/sendgrid-nodejs/tree/master/examples">example</a>
(make sure you have set your environment variable to include your
SENDGRID_API_KEY).</p>

<pre class="ruby"><span class="ruby-identifier">node</span> <span class="ruby-identifier">examples</span><span class="ruby-operator">/</span><span class="ruby-identifier">helpers</span><span class="ruby-operator">/</span><span class="ruby-identifier">mail</span><span class="ruby-operator">/</span><span class="ruby-identifier">example</span>.<span class="ruby-identifier">js</span>
</pre>
...
<p>See the <a
href="https://github.com/sendgrid/sendgrid-nodejs/tree/master/examples">example</a>
for a complete working example.</p>
</li><li>
<p><a
href="https://sendgrid.com/docs/API_Reference/Web_API_v3/Mail/overview.html">Documentation</a></p>
</li></ul>
</main>
