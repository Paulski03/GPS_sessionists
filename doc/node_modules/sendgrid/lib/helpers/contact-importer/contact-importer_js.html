...
<title>contact-importer.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/sendgrid/lib/helpers/contact-importer/contact-importer.js">

<pre>eslint dot-notation: &#39;off&#39;</pre>

<p>&#39;use strict&#39;;</p>

<p>var Bottleneck = require(&#39;bottleneck&#39;); var EventEmitter =
require(&#39;events&#39;).EventEmitter; var chunk =
require(&#39;lodash.chunk&#39;); var debug =
require(&#39;debug&#39;)(&#39;sendgrid&#39;); var util =
require(&#39;util&#39;); var queue = require(&#39;async.queue&#39;); var
ensureAsync = require(&#39;async.ensureasync&#39;);</p>

<p>var ContactImporter = module.exports = function(sg, options) {</p>
...
<p>}; util.inherits(ContactImporter, EventEmitter);</p>

<p>/**</p>

<pre>  Add a new contact, or an array of contact, to the end of the queue.

 @param {Array|Object} data A contact or array of contacts.
/</pre>

<p>ContactImporter.prototype.push = function(data) {</p>
...
debug(&#39;items in deferred queue: %s&#39;, this.pendingItems.length);</pre>

<p>};</p>

<p>/**</p>

<pre> Send a batch of contacts to Sendgrid.

 @param {Object} task Task to be processed (data in &#39;data&#39; property)
 @param {Function} callback Callback function.
/</pre>

<p>ContactImporter.prototype._worker = function(task, callback) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">context</span> = <span class="ruby-identifier">task</span>.<span class="ruby-identifier">owner</span>;
<span class="ruby-identifier">debug</span>(<span class="ruby-string">&#39;processing batch (%s items)&#39;</span>, <span class="ruby-identifier">task</span>.<span class="ruby-identifier">data</span>.<span class="ruby-identifier">length</span>);
<span class="ruby-identifier">context</span>.<span class="ruby-identifier">throttle</span>.<span class="ruby-identifier">submit</span>(<span class="ruby-identifier">context</span>.<span class="ruby-identifier">_sendBatch</span>, <span class="ruby-identifier">context</span>, <span class="ruby-identifier">task</span>.<span class="ruby-identifier">data</span>, <span class="ruby-identifier">callback</span>);
</pre>

<p>};</p>

<p>ContactImporter.prototype._sendBatch = function(context, data, callback) {</p>

<pre class="ruby"><span class="ruby-identifier">debug</span>(<span class="ruby-string">&#39;sending batch (%s items)&#39;</span>, <span class="ruby-identifier">data</span>.<span class="ruby-identifier">length</span>);

<span class="ruby-identifier">var</span> <span class="ruby-identifier">request</span> = <span class="ruby-identifier">context</span>.<span class="ruby-identifier">sg</span>.<span class="ruby-identifier">emptyRequest</span>();
<span class="ruby-identifier">request</span>.<span class="ruby-identifier">method</span> = <span class="ruby-string">&#39;POST&#39;</span>;
<span class="ruby-identifier">request</span>.<span class="ruby-identifier">path</span> = <span class="ruby-string">&#39;/v3/contactdb/recipients&#39;</span>;
<span class="ruby-identifier">request</span>.<span class="ruby-identifier">body</span> = <span class="ruby-identifier">data</span>;

<span class="ruby-identifier">context</span>.<span class="ruby-identifier">sg</span>.<span class="ruby-constant">API</span>(<span class="ruby-identifier">request</span>)
  .<span class="ruby-identifier">then</span>(<span class="ruby-identifier">function</span>(<span class="ruby-identifier">response</span>) {
    <span class="ruby-identifier">debug</span>(<span class="ruby-string">&#39;got response: %o&#39;</span>, <span class="ruby-identifier">response</span>);
    <span class="ruby-identifier">setTimeout</span>(<span class="ruby-identifier">function</span>() {
      <span class="ruby-identifier">context</span>.<span class="ruby-identifier">throttle</span>.<span class="ruby-identifier">incrementReservoir</span>(<span class="ruby-value">1</span>);
    }, <span class="ruby-identifier">context</span>.<span class="ruby-identifier">rateLimitPeriod</span>);
    <span class="ruby-keyword">return</span> <span class="ruby-identifier">callback</span>(<span class="ruby-identifier">null</span>, <span class="ruby-identifier">response</span>);
  })
  .<span class="ruby-identifier">catch</span>(<span class="ruby-identifier">function</span>(<span class="ruby-identifier">error</span>) {
    <span class="ruby-identifier">debug</span>(<span class="ruby-string">&#39;got error, %o&#39;</span>, <span class="ruby-identifier">error</span>);
    <span class="ruby-identifier">setTimeout</span>(<span class="ruby-identifier">function</span>() {
      <span class="ruby-identifier">context</span>.<span class="ruby-identifier">throttle</span>.<span class="ruby-identifier">incrementReservoir</span>(<span class="ruby-value">1</span>);
    }, <span class="ruby-identifier">context</span>.<span class="ruby-identifier">rateLimitPeriod</span>);
    <span class="ruby-keyword">return</span> <span class="ruby-identifier">callback</span>(<span class="ruby-identifier">error</span>);
  });
</pre>
...
<pre> Emit the result of processing a batch.

 @param {Object} error
 @param {Object} result
/</pre>

<p>ContactImporter.prototype._notify = function(error, result, batch) {</p>

<pre>if (error) {
  return this.emit(&#39;error&#39;, error, batch);
}
return this.emit(&#39;success&#39;, result, batch);</pre>
