...
<main role="main" aria-label="Page node_modules/sendgrid/lib/helpers/inbound/parse.js">

<p>&#39;use strict&#39;;</p>

<p>var fs = require(&#39;fs&#39;); var MailParser =
require(&#39;mailparser&#39;).MailParser; var Attachment =
require(&#39;../mail/mail.js&#39;).Attachment;</p>

<pre>Normalises attachment files retrieved from file system or parsed raw email

@param {Object} file The file object returned by file system or parsed email
@return {Object} A SendGrid Attachment object with the file data</pre>

<p>function createAttachment(file) {</p>

<pre>var attachment = new Attachment();
...
return attachment;</pre>

<p>}</p>

<p>/**</p>

<pre> Simple class that parses data received from SendGrid Inbound Parse Webhook
...
<p>function Parse(config, request) {</p>

<pre class="ruby"><span class="ruby-identifier">this</span>.<span class="ruby-identifier">keys</span> = <span class="ruby-identifier">config</span>.<span class="ruby-identifier">keys</span>;
<span class="ruby-identifier">this</span>.<span class="ruby-identifier">request</span> = <span class="ruby-identifier">request</span>;
<span class="ruby-identifier">this</span>.<span class="ruby-identifier">payload</span> = <span class="ruby-identifier">request</span>.<span class="ruby-identifier">body</span> <span class="ruby-operator">||</span> {};
<span class="ruby-identifier">this</span>.<span class="ruby-identifier">files</span> = <span class="ruby-identifier">request</span>.<span class="ruby-identifier">files</span> <span class="ruby-operator">||</span> [];
</pre>
...
<pre> Return an object literal of key/values in the payload received from webhook
 @return {Object} Valid key/values in the webhook payload
/</pre>

<p>Parse.prototype.keyValues = function() {</p>
...
return keyValues;</pre>

<p>};</p>

<p>/**</p>

<pre> Whether the payload contains the raw email (Only applies to raw payloads)
 @return {Boolean}
/</pre>

<p>Parse.prototype.hasRawEmail = function() {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-constant">Boolean</span>(<span class="ruby-identifier">this</span>.<span class="ruby-identifier">payload</span>.<span class="ruby-identifier">email</span>);
</pre>
...
<pre> Parses the raw email and returns the mail object in a callback (Only applies to raw payloads)
 @param {Function} callback Function which will receive the parsed email object as the sole argument
/</pre>

<p>Parse.prototype.getRawEmail = function(callback) {</p>

<pre>var mailparser = new MailParser();
...
<pre> Retrieves all attachments received from the webhook payload
 @param {Function} callback Function which will receive an array, of attachments found, as the sole argument
/</pre>

<p>Parse.prototype.attachments = function(callback) {</p>

<pre>if (this.hasRawEmail()) {
  return this._getAttachmentsRaw(callback);
}

this._getAttachments(callback);</pre>

<p>};</p>

<p>/**</p>

<pre> Parses raw email to retrieve any encoded attachments (Only applies to raw payloads)
 @private
 @param {Function} callback Function which will receive an array, of attachments found, as the sole argument
/</pre>

<p>Parse.prototype._getAttachmentsRaw = function(callback) {</p>

<pre>this.getRawEmail(function(parsedEmail) {
...
<pre> Retrieves webhook payload files from the file system (Only applies to non raw payloads)
 @private
 @param {Function} callback Function which will receive an array, of attachments found, as the sole argument
/</pre>

<p>Parse.prototype._getAttachments = function(callback) {</p>
...
return callback(attachments);</pre>
