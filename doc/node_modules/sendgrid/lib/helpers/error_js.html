...
<title>error.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/sendgrid/lib/helpers/error.js">

<p>&#39;use strict&#39;;</p>

<p>//Error constructor function SendGridError(message) {</p>

<pre>this.message = message;
...
<p>//Extend prototype SendGridError.prototype = new Error();
SendGridError.prototype.constructor = SendGridError;
SendGridError.prototype.name = &#39;SendGridError&#39;;</p>

<p>//Export module.exports = SendGridError;</p>
</main>
