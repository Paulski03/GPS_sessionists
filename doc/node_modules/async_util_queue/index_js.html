...
<main role="main" aria-label="Page node_modules/async.util.queue/index.js">

<p>&#39;use strict&#39;;</p>

<p>var map = require(&#39;async.util.map&#39;); var noop =
require(&#39;async.util.noop&#39;); var isArray =
require(&#39;async.util.isarray&#39;); var onlyOnce =
require(&#39;async.util.onlyonce&#39;); var arrayEach =
require(&#39;async.util.arrayeach&#39;); var setImmediate =
require(&#39;async.util.setimmediate&#39;);</p>

<p>module.exports = function queue(worker, concurrency, payload) {</p>

<pre>if (concurrency == null)
    concurrency = 1;
