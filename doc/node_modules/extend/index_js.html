...
<main role="main" aria-label="Page node_modules/extend/index.js">

<p>&#39;use strict&#39;;</p>

<p>var hasOwn = Object.prototype.hasOwnProperty; var toStr =
Object.prototype.toString;</p>

<p>var isArray = function isArray(arr) {</p>

<pre>if (typeof Array.isArray === &#39;function&#39;) {
        return Array.isArray(arr);
}

return toStr.call(arr) === &#39;[object Array]&#39;;</pre>

<p>};</p>

<p>var isPlainObject = function isPlainObject(obj) {</p>

<pre>if (!obj || toStr.call(obj) !== &#39;[object Object]&#39;) {
        return false;
}
...
return typeof key === &#39;undefined&#39; || hasOwn.call(obj, key);</pre>

<p>};</p>

<p>module.exports = function extend() {</p>

<pre>var options, name, src, copy, copyIsArray, clone;
