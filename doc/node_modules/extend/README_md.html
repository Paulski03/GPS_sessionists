...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-extend-28-29+for+Node.js+-3Crdoc-image-3Ahttp-3A-2F-2Fversionbadg.es-2Fjustmoon-2Fnode-extend.svg-3C-2Fsup-3E">extend() for Node.js &lt;sup&gt;{rdoc-image:http://versionbadg.es/justmoon/node-extend.svg}[https://npmjs.org/package/extend]</sup&gt;</a>
...
<main role="main" aria-label="Page node_modules/extend/README.md">

<p><a href="https://travis-ci.org/justmoon/node-extend"><img
src="https://travis-ci.org/justmoon/node-extend.svg"></a> <a
href="https://david-dm.org/justmoon/node-extend"><img
src="https://david-dm.org/justmoon/node-extend.svg"></a> <a
href="https://david-dm.org/justmoon/node-extend#info=devDependencies"><img
src="https://david-dm.org/justmoon/node-extend/dev-status.svg"></a></p>

<h1 id="label-extend-28-29+for+Node.js+-3Crdoc-image-3Ahttp-3A-2F-2Fversionbadg.es-2Fjustmoon-2Fnode-extend.svg-3C-2Fsup-3E">extend() for Node.js &lt;sup&gt;{rdoc-image:http://versionbadg.es/justmoon/node-extend.svg}[https://npmjs.org/package/extend]</sup&gt;<span><a href="#label-extend-28-29+for+Node.js+-3Crdoc-image-3Ahttp-3A-2F-2Fversionbadg.es-2Fjustmoon-2Fnode-extend.svg-3C-2Fsup-3E">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p><code>node-extend</code> is a port of the classic extend() method from
jQuery. It behaves as you expect. It is simple, tried and true.</p>

<p>Notes:</p>
<ul><li>
<p>Since Node.js &gt;= 4,  <a
href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object/assign">Object.assign</a>
now offers the same functionality natively (but without the “deep copy”
option).  See <a href="https://nodejs.org/en/docs/es6">ECMAScript 2015
(ES6) in Node.js</a>.</p>
</li><li>
<p>Some native implementations of <code>Object.assign</code> in both Node.js
and many  browsers (since NPM modules are for the browser too) may not be
fully  spec-compliant.  Check <a
href="https://www.npmjs.com/package/object.assign">object.assign</a> module
for  a compliant candidate.</p>
</li></ul>

<h2 id="label-Installation">Installation<span><a href="#label-Installation">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>This package is available on <a
href="https://npmjs.org/package/extend">npm</a> as: <code>extend</code></p>

<pre class="ruby"><span class="ruby-identifier">npm</span> <span class="ruby-identifier">install</span> <span class="ruby-identifier">extend</span>
</pre>

<h2 id="label-Usage">Usage<span><a href="#label-Usage">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p><strong>Syntax:</strong> extend <strong>(</strong> [<code>deep</code>],
<code>target</code>, <code>object1</code>, [<code>objectN</code>]
<strong>)</strong></p>

<p><em>Extend one object with one or more others, returning the modified
object.</em></p>

<p><strong>Example:</strong></p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">extend</span> = <span class="ruby-identifier">require</span>(<span class="ruby-string">&#39;extend&#39;</span>);
<span class="ruby-identifier">extend</span>(<span class="ruby-identifier">targetObject</span>, <span class="ruby-identifier">object1</span>, <span class="ruby-identifier">object2</span>);
</pre>

<p>Keep in mind that the target object will be modified, and will be returned
from extend().</p>

<p>If a boolean true is specified as the first argument, extend performs a
deep copy, recursively copying any objects it finds. Otherwise, the copy
will share structure with the original object(s). Undefined properties are
not copied. However, properties inherited from the object&#39;s prototype
will be copied over. Warning: passing <code>false</code> as the first
argument is not supported.</p>

<h3 id="label-Arguments">Arguments<span><a href="#label-Arguments">&para;</a> <a href="#top">&uarr;</a></span></h3>
<ul><li>
<p><code>deep</code> <em>Boolean</em> (optional) If set, the merge becomes
recursive (i.e. deep copy).</p>
</li><li>
<p><code>target</code> <em>Object</em> The object to extend.</p>
</li><li>
<p><code>object1</code> <em>Object</em> The object that will be merged into
the first.</p>
</li><li>
<p><code>objectN</code> <em>Object</em> (Optional) More objects to merge into
the first.</p>
</li></ul>

<h2 id="label-License">License<span><a href="#label-License">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p><code>node-extend</code> is licensed under the <a
...
<p>Ported to Node.js by <a href="https://github.com/justmoon">Stefan
Thomas</a> with contributions by <a
href="https://github.com/insin">Jonathan Buchanan</a> and <a
href="https://github.com/ljharb">Jordan Harband</a>.</p>
</main>
