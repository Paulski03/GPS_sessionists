...
<title>mime.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/mime/mime.js">

<p>var path = require(&#39;path&#39;); var fs = require(&#39;fs&#39;);</p>

<p>function Mime() {</p>

<pre>// Map of extension -&gt; mime type
this.types = Object.create(null);

// Map of mime type -&gt; extension
this.extensions = Object.create(null);</pre>

<p>}</p>

<pre>Define mimetype -&gt; extension mappings.  Each key is a mime-type that maps
to an array of extensions associated with the type.  The first extension is
used as the default extension for the type.

e.g. mime.define({&#39;audio/ogg&#39;, [&#39;oga&#39;, &#39;ogg&#39;, &#39;spx&#39;]});

@param map (Object) type definitions</pre>

<p>Mime.prototype.define = function (map) {</p>

<pre>for (var type in map) {
  var exts = map[type];
...
<pre> Load an Apache2-style &quot;.types&quot; file
...
<p>Mime.prototype.load = function(file) {</p>

<pre>this._loading = file;
...
this._loading = null;</pre>

<p>};</p>

<p>/**</p>

<pre> Lookup a mime type based on extension
/</pre>

<p>Mime.prototype.lookup = function(path, fallback) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">ext</span> = <span class="ruby-identifier">path</span>.<span class="ruby-identifier">replace</span>(<span class="ruby-regexp">/.*[\.\/\]/</span>, <span class="ruby-string">&#39;&#39;</span>).<span class="ruby-identifier">toLowerCase</span>();
...
<pre> Return file extension associated with a mime type
/</pre>

<p>Mime.prototype.extension = function(mimeType) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">type</span> = <span class="ruby-identifier">mimeType</span>.<span class="ruby-identifier">match</span>(<span class="ruby-regexp">/^\s*([^;\s]*)(?:;|\s|$)/</span>)[<span class="ruby-value">1</span>].<span class="ruby-identifier">toLowerCase</span>();
<span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">extensions</span>[<span class="ruby-identifier">type</span>];
</pre>

<p>};</p>

<p>// Default instance var mime = new Mime();</p>

<p>// Define built-in types mime.define(require(&#39;./types.json&#39;));</p>

<p>// Default type mime.default_type = mime.lookup(&#39;bin&#39;);</p>
...
<pre class="ruby"> <span class="ruby-constant">Lookup</span> <span class="ruby-identifier">a</span> <span class="ruby-identifier">charset</span> <span class="ruby-identifier">based</span> <span class="ruby-identifier">on</span> <span class="ruby-identifier">mime</span> <span class="ruby-identifier">type</span>.
<span class="ruby-operator">/</span>
</pre>

<p>mime.charsets = {</p>

<pre>lookup: function(mimeType, fallback) {
