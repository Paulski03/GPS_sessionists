...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-mime">mime</a>
    <li><a href="#label-Install">Install</a>
    <li><a href="#label-Contributing+-2F+Testing">Contributing / Testing</a>
    <li><a href="#label-Command+Line">Command Line</a>
    <li><a href="#label-API+-+Queries">API - Queries</a>
    <li><a href="#label-mime.lookup-28path-29">mime.lookup(path)</a>
    <li><a href="#label-mime.default_type">mime.default_type</a>
    <li><a href="#label-mime.extension-28type-29">mime.extension(type)</a>
    <li><a href="#label-mime.charsets.lookup-28-29">mime.charsets.lookup()</a>
    <li><a href="#label-API+-+Defining+Custom+Types">API - Defining Custom Types</a>
    <li><a href="#label-mime.define-28-29">mime.define()</a>
    <li><a href="#label-mime.load-28filepath-29">mime.load(filepath)</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/mime/README.md">

<h1 id="label-mime">mime<span><a href="#label-mime">&para;</a> <a href="#top">&uarr;</a></span></h1>
...
<pre class="ruby"><span class="ruby-identifier">npm</span> <span class="ruby-identifier">install</span> <span class="ruby-identifier">mime</span>
</pre>

<h2 id="label-Contributing+-2F+Testing">Contributing / Testing<span><a href="#label-Contributing+-2F+Testing">&para;</a> <a href="#top">&uarr;</a></span></h2>

<pre class="ruby"><span class="ruby-identifier">npm</span> <span class="ruby-identifier">run</span> <span class="ruby-identifier">test</span>
</pre>

<h2 id="label-Command+Line">Command Line<span><a href="#label-Command+Line">&para;</a> <a href="#top">&uarr;</a></span></h2>

<pre class="ruby"><span class="ruby-identifier">mime</span> [<span class="ruby-identifier">path_string</span>]
</pre>

<p>E.g.</p>

<pre>&gt; mime scripts/jquery.js
application/javascript</pre>

<h2 id="label-API+-+Queries">API - Queries<span><a href="#label-API+-+Queries">&para;</a> <a href="#top">&uarr;</a></span></h2>

<h3 id="label-mime.lookup-28path-29">mime.lookup(path)<span><a href="#label-mime.lookup-28path-29">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Get the mime type associated with a file, if no mime type is found
<code>application/octet-stream</code> is returned. Performs a
case-insensitive lookup using the extension in <code>path</code> (the
substring after the last &#39;/&#39; or &#39;.&#39;). E.g.</p>

<pre>var mime = require(&#39;mime&#39;);

mime.lookup(&#39;/path/to/file.txt&#39;);         // =&gt; &#39;text/plain&#39;
mime.lookup(&#39;file.txt&#39;);                  // =&gt; &#39;text/plain&#39;
mime.lookup(&#39;.TXT&#39;);                      // =&gt; &#39;text/plain&#39;
mime.lookup(&#39;htm&#39;);                       // =&gt; &#39;text/html&#39;</pre>

<h3 id="label-mime.default_type">mime.default_type<span><a href="#label-mime.default_type">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Sets the mime type returned when <code>mime.lookup</code> fails to find the
extension searched for. (Default is <code>application/octet-stream</code>.)</p>

<h3 id="label-mime.extension-28type-29">mime.extension(type)<span><a href="#label-mime.extension-28type-29">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Get the default extension for <code>type</code></p>

<pre>mime.extension(&#39;text/html&#39;);                 // =&gt; &#39;html&#39;
mime.extension(&#39;application/octet-stream&#39;);  // =&gt; &#39;bin&#39;</pre>

<h3 id="label-mime.charsets.lookup-28-29">mime.charsets.lookup()<span><a href="#label-mime.charsets.lookup-28-29">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Map mime-type to charset</p>

<pre>mime.charsets.lookup(&#39;text/plain&#39;);        // =&gt; &#39;UTF-8&#39;</pre>

<p>(The logic for charset lookups is pretty rudimentary. Feel free to suggest
improvements.)</p>

<h2 id="label-API+-+Defining+Custom+Types">API - Defining Custom Types<span><a href="#label-API+-+Defining+Custom+Types">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Custom type mappings can be added on a per-project basis via the following
APIs.</p>

<h3 id="label-mime.define-28-29">mime.define()<span><a href="#label-mime.define-28-29">&para;</a> <a href="#top">&uarr;</a></span></h3>
...
mime.lookup(&#39;x-sft&#39;);                 // =&gt; &#39;text/x-some-format&#39;</pre>

<p>The first entry in the extensions array is returned by
<code>mime.extension()</code>. E.g.</p>

<pre>mime.extension(&#39;text/x-some-format&#39;); // =&gt; &#39;x-sf&#39;</pre>

<h3 id="label-mime.load-28filepath-29">mime.load(filepath)<span><a href="#label-mime.load-28filepath-29">&para;</a> <a href="#top">&uarr;</a></span></h3>

<p>Load mappings from an Apache “.types” format file</p>

<pre class="ruby"><span class="ruby-identifier">mime</span>.<span class="ruby-identifier">load</span>(<span class="ruby-string">&#39;./my_project.types&#39;</span>);
</pre>

<p>The .types file format is simple - See the <code>types</code> dir for
examples.</p>
</main>
