...
<title>build.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/mime/build/build.js">

<p>var db = require(&#39;mime-db&#39;);</p>

<p>var mapByType = {}; Object.keys(db).forEach(function(key) {</p>

<pre>var extensions = db[key].extensions;
if (extensions) {
...
<p>console.log(JSON.stringify(mapByType));</p>
</main>
