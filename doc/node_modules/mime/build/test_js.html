...
<main role="main" aria-label="Page node_modules/mime/build/test.js">

<pre>Usage: node test.js</pre>

<p>var mime = require(&#39;../mime&#39;); var assert =
require(&#39;assert&#39;); var path = require(&#39;path&#39;);</p>

<p>// // Test mime lookups //</p>

<p>assert.equal(&#39;text/plain&#39;, mime.lookup(&#39;text.txt&#39;));     //
normal file assert.equal(&#39;text/plain&#39;,
mime.lookup(&#39;TEXT.TXT&#39;));     // uppercase
assert.equal(&#39;text/plain&#39;, mime.lookup(&#39;dir/text.txt&#39;)); //
dir + file assert.equal(&#39;text/plain&#39;,
mime.lookup(&#39;.text.txt&#39;));    // hidden file
assert.equal(&#39;text/plain&#39;, mime.lookup(&#39;.txt&#39;));         //
nameless assert.equal(&#39;text/plain&#39;, mime.lookup(&#39;txt&#39;));   
// extension-only assert.equal(&#39;text/plain&#39;,
mime.lookup(&#39;/txt&#39;));         // extension-less ()
assert.equal(&#39;text/plain&#39;, mime.lookup(&#39;\txt&#39;));        //
Windows, extension-less assert.equal(&#39;application/octet-stream&#39;,
mime.lookup(&#39;text.nope&#39;)); // unrecognized
assert.equal(&#39;fallback&#39;, mime.lookup(&#39;text.fallback&#39;,
&#39;fallback&#39;)); // alternate default</p>

<p>// // Test extensions //</p>

<p>assert.equal(&#39;txt&#39;, mime.extension(mime.types.text));
assert.equal(&#39;html&#39;, mime.extension(mime.types.htm));
assert.equal(&#39;bin&#39;,
mime.extension(&#39;application/octet-stream&#39;));
assert.equal(&#39;bin&#39;, mime.extension(&#39;application/octet-stream
&#39;)); assert.equal(&#39;html&#39;, mime.extension(&#39; text/html;
charset=UTF-8&#39;)); assert.equal(&#39;html&#39;,
...
mime.extension(&#39;text/html;charset=UTF-8&#39;));
assert.equal(&#39;html&#39;,
mime.extension(&#39;text/Html;charset=UTF-8&#39;)); assert.equal(undefined,
mime.extension(&#39;unrecognized&#39;));</p>

<p>// // Test node.types lookups //</p>

<p>assert.equal(&#39;application/font-woff&#39;,
mime.lookup(&#39;file.woff&#39;));
assert.equal(&#39;application/octet-stream&#39;,
mime.lookup(&#39;file.buffer&#39;)); // TODO: Uncomment once #157 is
resolved // assert.equal(&#39;audio/mp4&#39;,
mime.lookup(&#39;file.m4a&#39;)); assert.equal(&#39;font/opentype&#39;,
mime.lookup(&#39;file.otf&#39;));</p>

<p>// // Test charsets //</p>

<p>assert.equal(&#39;UTF-8&#39;, mime.charsets.lookup(&#39;text/plain&#39;));
...
mime.charsets.lookup(&#39;application/octet-stream&#39;,
&#39;fallback&#39;));</p>

<p>console.log(&#39;nAll tests passed&#39;);</p>
</main>
