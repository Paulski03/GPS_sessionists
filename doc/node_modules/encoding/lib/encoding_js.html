...
<title>encoding.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/encoding/lib/encoding.js">

<p>&#39;use strict&#39;;</p>

<p>var iconvLite = require(&#39;iconv-lite&#39;); // Load Iconv from an
external file to be able to disable Iconv for webpack // Add
//iconv-loader$/ to webpack.IgnorePlugin to ignore it var Iconv =
require(&#39;./iconv-loader&#39;);</p>

<p>// Expose to the world module.exports.convert = convert;</p>

<pre>Convert encoding of an UTF-8 string or a buffer

@param {String|Buffer} str String to be converted
@param {String} to Encoding to be converted to
@param {String} [from=&#39;UTF-8&#39;] Encoding to be converted from
@param {Boolean} useLite If set to ture, force to use iconvLite
@return {Buffer} Encoded string</pre>

<p>function convert(str, to, from, useLite) {</p>

<pre>from = checkEncoding(from || &#39;UTF-8&#39;);
...
<pre> Convert encoding of a string with node-iconv (if available)
...
<p>function convertIconv(str, to, from) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">response</span>, <span class="ruby-identifier">iconv</span>;
<span class="ruby-identifier">iconv</span> = <span class="ruby-identifier">new</span> <span class="ruby-constant">Iconv</span>(<span class="ruby-identifier">from</span>, <span class="ruby-identifier">to</span> <span class="ruby-operator">+</span> <span class="ruby-string">&#39;//TRANSLIT//IGNORE&#39;</span>);
<span class="ruby-identifier">response</span> = <span class="ruby-identifier">iconv</span>.<span class="ruby-identifier">convert</span>(<span class="ruby-identifier">str</span>);
<span class="ruby-keyword">return</span> <span class="ruby-identifier">response</span>.<span class="ruby-identifier">slice</span>(<span class="ruby-value">0</span>, <span class="ruby-identifier">response</span>.<span class="ruby-identifier">length</span>);
</pre>
...
<pre> Convert encoding of astring with iconv-lite
...
<p>function convertIconvLite(str, to, from) {</p>
...
<pre> Converts charset name if needed

 @param {String} name Character set
 @return {String} Character set name
/</pre>

<p>function checkEncoding(name) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> (<span class="ruby-identifier">name</span> <span class="ruby-operator">||</span> <span class="ruby-string">&#39;&#39;</span>).<span class="ruby-identifier">toString</span>().<span class="ruby-identifier">trim</span>().
<span class="ruby-identifier">replace</span>(<span class="ruby-regexp">/^latin[\-_]?(\d+)$/i</span>, <span class="ruby-string">&#39;ISO-8859-$1&#39;</span>).
<span class="ruby-identifier">replace</span>(<span class="ruby-regexp">/^win(?:dows)?[\-_]?(\d+)$/i</span>, <span class="ruby-string">&#39;WINDOWS-$1&#39;</span>).
<span class="ruby-identifier">replace</span>(<span class="ruby-regexp">/^utf[\-_]?(\d+)$/i</span>, <span class="ruby-string">&#39;UTF-$1&#39;</span>).
<span class="ruby-identifier">replace</span>(<span class="ruby-regexp">/^ks_c_5601\-1987$/i</span>, <span class="ruby-string">&#39;CP949&#39;</span>).
<span class="ruby-identifier">replace</span>(<span class="ruby-regexp">/^us[\-_]?ascii$/i</span>, <span class="ruby-string">&#39;ASCII&#39;</span>).
<span class="ruby-identifier">toUpperCase</span>();
</pre>
