...
<title>iconv-loader.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/encoding/lib/iconv-loader.js">

<p>&#39;use strict&#39;;</p>

<p>var iconv_package; var Iconv;</p>

<p>try {</p>

<pre>// this is to fool browserify so it doesn&#39;t try (in vain) to install iconv.
iconv_package = &#39;iconv&#39;;
Iconv = require(iconv_package).Iconv;</pre>

<p>} catch (E) {</p>

<pre>// node-iconv not present</pre>

<p>}</p>

<p>module.exports = Iconv;</p>
</main>
