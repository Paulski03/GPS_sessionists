...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-Encoding">Encoding</a>
...
<main role="main" aria-label="Page node_modules/encoding/README.md">

<h1 id="label-Encoding">Encoding<span><a href="#label-Encoding">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p><strong>encoding</strong> is a simple wrapper around <a
href="https://github.com/bnoordhuis/node-iconv">node-iconv</a> and <a
href="https://github.com/ashtuchkin/iconv-lite/">iconv-lite</a> to convert
strings from one encoding to another. If node-iconv is not available for
some reason, iconv-lite will be used instead of it as a fallback.</p>

<p><a href="http://travis-ci.org/andris9/Nodemailer"><img
src="https://secure.travis-ci.org/andris9/encoding.svg"></a> <a
href="http://badge.fury.io/js/encoding"><img
src="https://badge.fury.io/js/encoding.svg"></a></p>

<h2 id="label-Install">Install<span><a href="#label-Install">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>Install through npm</p>

<pre class="ruby"><span class="ruby-identifier">npm</span> <span class="ruby-identifier">install</span> <span class="ruby-identifier">encoding</span>
</pre>
...
<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">encoding</span> = <span class="ruby-identifier">require</span>(<span class="ruby-string">&quot;encoding&quot;</span>);
</pre>

<p>Convert with encoding.convert()</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">resultBuffer</span> = <span class="ruby-identifier">encoding</span>.<span class="ruby-identifier">convert</span>(<span class="ruby-identifier">text</span>, <span class="ruby-identifier">toCharset</span>, <span class="ruby-identifier">fromCharset</span>);
</pre>

<p>Where</p>
<ul><li>
<p><strong>text</strong> is either a Buffer or a String to be converted</p>
</li><li>
<p><strong>toCharset</strong> is the characterset to convert the string</p>
</li><li>
<p><strong>fromCharset</strong> (<em>optional</em>, defaults to UTF-8) is the
source charset</p>
</li></ul>
...
<pre>var result = encoding.convert(&quot;ÕÄÖÜ&quot;, &quot;Latin_1&quot;);
console.log(result); //&lt;Buffer d5 c4 d6 dc&gt;</pre>

<h2 id="label-iconv+support">iconv support<span><a href="#label-iconv+support">&para;</a> <a href="#top">&uarr;</a></span></h2>

<p>By default only iconv-lite is bundled. If you need node-iconv support, you
need to add it as an additional dependency for your project:</p>
