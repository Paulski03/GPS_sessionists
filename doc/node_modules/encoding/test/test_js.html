...
<main role="main" aria-label="Page node_modules/encoding/test/test.js">

<p>&#39;use strict&#39;;</p>

<p>var Iconv = require(&#39;../lib/iconv-loader&#39;); var encoding =
require(&#39;../lib/encoding&#39;);</p>

<p>exports[&#39;General tests&#39;] = {</p>

<pre>&#39;Iconv is available&#39;: function (test) {
    test.ok(Iconv);
    test.done();
},
