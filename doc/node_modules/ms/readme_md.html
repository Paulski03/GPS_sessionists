...
<div class="nav-section">
  ...
  <ul class="link-list" role="directory">
    <li><a href="#label-ms">ms</a>
    <li><a href="#label-Examples">Examples</a>
    <li><a href="#label-Convert+from+milliseconds">Convert from milliseconds</a>
    <li><a href="#label-Time+format+written-out">Time format written-out</a>
    <li><a href="#label-Features">Features</a>
    <li><a href="#label-Caught+a+bug-3F">Caught a bug?</a>
  </ul>
</div>
...
<main role="main" aria-label="Page node_modules/ms/readme.md">

<h1 id="label-ms">ms<span><a href="#label-ms">&para;</a> <a href="#top">&uarr;</a></span></h1>

<p><a href="https://travis-ci.org/zeit/ms"><img
src="https://travis-ci.org/zeit/ms.svg?branch=master"></a> <a
href="https://zeit.chat/"><img
src="http://zeit-slackin.now.sh/badge.svg"></a></p>
...
<h3 id="label-Convert+from+milliseconds">Convert from milliseconds<span><a href="#label-Convert+from+milliseconds">&para;</a> <a href="#top">&uarr;</a></span></h3>

<pre>ms(60000)             // &quot;1m&quot;
ms(2 * 60000)         // &quot;2m&quot;
ms(ms(&#39;10 hours&#39;))    // &quot;10h&quot;</pre>

<h3 id="label-Time+format+written-out">Time format written-out<span><a href="#label-Time+format+written-out">&para;</a> <a href="#top">&uarr;</a></span></h3>

<pre>ms(60000, { long: true })             // &quot;1 minute&quot;
ms(2 * 60000, { long: true })         // &quot;2 minutes&quot;
ms(ms(&#39;10 hours&#39;), { long: true })    // &quot;10 hours&quot;</pre>

<h2 id="label-Features">Features<span><a href="#label-Features">&para;</a> <a href="#top">&uarr;</a></span></h2>
<ul><li>
<p>Works both in <a href="https://nodejs.org">node</a> and in the browser.</p>
</li><li>
<p>If a number is supplied to <code>ms</code>, a string with a unit is
returned.</p>
</li><li>
<p>If a string that contains the number is supplied, it returns it as a number
(e.g.: it returns <code>100</code> for <code>&#39;100&#39;</code>).</p>
</li><li>
<p>If you pass a string with a number and a valid unit, the number of
equivalent ms is returned.</p>
</li></ul>

<h2 id="label-Caught+a+bug-3F">Caught a bug?<span><a href="#label-Caught+a+bug-3F">&para;</a> <a href="#top">&uarr;</a></span></h2>
<ol><li>
<p><a href="https://help.github.com/articles/fork-a-repo/">Fork</a> this
repository to your own GitHub account and then <a
href="https://help.github.com/articles/cloning-a-repository/">clone</a> it
to your local device</p>
</li><li>
<p>Link the package to the global module directory: <code>npm link</code></p>
</li><li>
<p>Within the module you want to test your local development instance of ms,
just link it to the dependencies: <code>npm link ms</code>. Instead of the
default one from npm, node will now use your clone of ms!</p>
</li></ol>
