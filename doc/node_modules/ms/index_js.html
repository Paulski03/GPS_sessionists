...
<main role="main" aria-label="Page node_modules/ms/index.js">

<pre>Helpers.</pre>

<p>var s = 1000; var m = s * 60; var h = m * 60; var d = h * 24; var y = d *
365.25;</p>

<p>/**</p>

<pre> Parse or format the given `val`.
...
<p>module.exports = function(val, options) {</p>
...
<pre> Parse the given `str` and return milliseconds.
...
<p>function fmtLong(ms) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">plural</span>(<span class="ruby-identifier">ms</span>, <span class="ruby-identifier">d</span>, <span class="ruby-string">&#39;day&#39;</span>) <span class="ruby-operator">||</span>
  <span class="ruby-identifier">plural</span>(<span class="ruby-identifier">ms</span>, <span class="ruby-identifier">h</span>, <span class="ruby-string">&#39;hour&#39;</span>) <span class="ruby-operator">||</span>
  <span class="ruby-identifier">plural</span>(<span class="ruby-identifier">ms</span>, <span class="ruby-identifier">m</span>, <span class="ruby-string">&#39;minute&#39;</span>) <span class="ruby-operator">||</span>
  <span class="ruby-identifier">plural</span>(<span class="ruby-identifier">ms</span>, <span class="ruby-identifier">s</span>, <span class="ruby-string">&#39;second&#39;</span>) <span class="ruby-operator">||</span>
  <span class="ruby-identifier">ms</span> <span class="ruby-operator">+</span> <span class="ruby-string">&#39; ms&#39;</span>;
</pre>
...
<pre class="ruby"> <span class="ruby-constant">Pluralization</span> <span class="ruby-identifier">helper</span>.
<span class="ruby-operator">/</span>
</pre>

<p>function plural(ms, n, name) {</p>
...
return Math.ceil(ms / n) + &#39; &#39; + name + &#39;s&#39;;</pre>
