...
<main role="main" aria-label="Page node_modules/bottleneck/test/index.js">

<p>global.TEST = true global.Bottleneck = require(&#39;../lib/index.js&#39;)
global.DLList = require(&#39;../lib/DLList.js&#39;) global.makeTest =
function (arg1, arg2, arg3, arg4, arg5) {</p>
...
<p>var fs = require(&#39;fs&#39;) var files = fs.readdirSync(&#39;./test&#39;)
for (var f in files) {</p>

<pre>var stat = fs.statSync(&#39;./test/&#39; + files[f])
if (!stat.isDirectory()) {
  try {
    require(&#39;./&#39; + files[f])
  } catch (e) {
