...
<title>Cluster.coffee - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bottleneck/src/Cluster.coffee">

<p>class Cluster</p>

<pre>constructor: (@maxNb, @minTime, @highWater, @strategy, @rejectOnDrop) -&gt;
        @limiters = {}
...
changeTimeout: (@timeout) -&gt; @startAutoCleanup()</pre>

<p>module.exports = Cluster</p>
</main>
