...
<title>DLList.coffee - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bottleneck/src/DLList.coffee">
...
getArray: () -&gt;
  node = @_first
  while node? then (ref = node; node = node.next; ref.value)</pre>

<p>module.exports = DLList</p>
</main>
