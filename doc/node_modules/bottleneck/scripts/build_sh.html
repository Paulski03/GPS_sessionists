...
<title>build.sh - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bottleneck/scripts/build.sh">

<p>#!/usr/bin/env bash</p>

<p>if [ ! -d node_modules ]; then</p>

<pre class="ruby"><span class="ruby-identifier">echo</span> <span class="ruby-string">&#39;Installing compiler tools...&#39;</span>
<span class="ruby-identifier">sleep</span> <span class="ruby-value">1</span>
<span class="ruby-identifier">npm</span> <span class="ruby-identifier">install</span>
</pre>

<p>fi</p>

<p>node_modules/coffee-script/bin/coffee -c src/*.coffee rm lib/*.js mv
src/*.js lib/</p>

<p>if [[ $1 = &#39;compile&#39; ]]; then</p>

<pre class="ruby"><span class="ruby-identifier">echo</span> <span class="ruby-string">&#39;Compiling bottleneck...&#39;</span>
</pre>

<p>else</p>

<pre>echo &#39;Building bottleneck...&#39;
node_modules/browserify/bin/cmd.js -u bluebird lib/index.js &gt; bottleneck.js
node_modules/uglify-js/bin/uglifyjs bottleneck.js -o bottleneck.min.js</pre>
