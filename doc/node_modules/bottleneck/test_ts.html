...
<title>test.ts - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/bottleneck/test.ts">

<p>/// &lt;reference path=“bottleneck.d.ts” /&gt;</p>

<p>import Bottleneck from “bottleneck”;</p>

<p>function withCb(foo: number, bar: () =&gt; void, cb: (err: any, result:
string) =&gt; void) {</p>

<pre class="ruby"><span class="ruby-identifier">cb</span>(<span class="ruby-identifier">undefined</span>, <span class="ruby-string">&quot;foo&quot;</span>);
</pre>

<p>}</p>

<p>let limiter = new Bottleneck(5, 1000, 10, Bottleneck.strategy.LEAK, true);</p>

<p>limiter.submit(withCb, 1, () =&gt; {}, (err, result) =&gt; {</p>

<pre class="ruby"><span class="ruby-identifier">let</span> <span class="ruby-identifier">s</span><span class="ruby-operator">:</span> <span class="ruby-identifier">string</span> = <span class="ruby-identifier">result</span>;
</pre>

<p>});</p>

<p>limiter.submitPriority(4, withCb, 1, () =&gt; {}, (err, result) =&gt; {</p>
...
<p>function withPromise(foo: number, bar: () =&gt; void):
PromiseLike&lt;string&gt; {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-constant">Promise</span>.<span class="ruby-identifier">resolve</span>(<span class="ruby-string">&quot;foo&quot;</span>);
</pre>

<p>}</p>

<p>let foo: Promise&lt;string&gt; = limiter.schedule(withPromise, 1, () =&gt;
{}); let foo2: Promise&lt;string&gt; = limiter.schedulePriority(4,
withPromise, 1, () =&gt; {});</p>

<p>let cluster = new Bottleneck.Cluster(5, 1000, 10, Bottleneck.strategy.LEAK,
true);</p>

<p>cluster.key(“foo”).submit(withCb, 1, () =&gt; {}, (err, result) =&gt; {</p>
...
<p>cluster.key(“bar”).submitPriority(4, withCb, 1, () =&gt; {}, (err, result)
=&gt; {</p>
...
<p>foo = cluster.key(“pizza”).schedule(withPromise, 1, () =&gt; {}); foo2 =
cluster.key(“pie”).schedulePriority(4, withPromise, 1, () =&gt; {});</p>
</main>
