...
<main role="main" aria-label="Page node_modules/iconv-lite/lib/index.d.ts">
...
<p>declare module &#39;iconv-lite&#39; {</p>

<pre>export function decode(buffer: NodeBuffer, encoding: string, options?: Options): string;
...
export function encodeStream(encoding: string, options?: Options): NodeJS.ReadWriteStream;</pre>

<p>}</p>

<p>export interface Options {</p>

<pre>stripBOM?: boolean;
addBOM?: boolean;
defaultEncoding?: string;</pre>
