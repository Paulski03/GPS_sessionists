...
<title>bom-handling.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/iconv-lite/lib/bom-handling.js">

<p>“use strict”;</p>

<p>var BOMChar = &#39;uFEFF&#39;;</p>

<p>exports.PrependBOM = PrependBOMWrapper function PrependBOMWrapper(encoder,
options) {</p>

<pre class="ruby"><span class="ruby-identifier">this</span>.<span class="ruby-identifier">encoder</span> = <span class="ruby-identifier">encoder</span>;
<span class="ruby-identifier">this</span>.<span class="ruby-identifier">addBOM</span> = <span class="ruby-keyword">true</span>;
</pre>

<p>}</p>

<p>PrependBOMWrapper.prototype.write = function(str) {</p>
...
return this.encoder.write(str);</pre>

<p>}</p>

<p>PrependBOMWrapper.prototype.end = function() {</p>
...
<p>exports.StripBOM = StripBOMWrapper; function StripBOMWrapper(decoder,
options) {</p>

<pre class="ruby"><span class="ruby-identifier">this</span>.<span class="ruby-identifier">decoder</span> = <span class="ruby-identifier">decoder</span>;
<span class="ruby-identifier">this</span>.<span class="ruby-identifier">pass</span> = <span class="ruby-keyword">false</span>;
...
<p>StripBOMWrapper.prototype.write = function(buf) {</p>

<pre>var res = this.decoder.write(buf);
if (this.pass || !res)
    return res;
...
<p>StripBOMWrapper.prototype.end = function() {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">decoder</span>.<span class="ruby-identifier">end</span>();
</pre>
