...
<title>streams.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/iconv-lite/lib/streams.js">

<p>“use strict”;</p>

<p>var Buffer = require(“buffer”).Buffer,</p>

<pre class="ruby"><span class="ruby-constant">Transform</span> = <span class="ruby-identifier">require</span>(<span class="ruby-string">&quot;stream&quot;</span>).<span class="ruby-constant">Transform</span>;
</pre>

<p>// == Exports
==================================================================
module.exports = function(iconv) {</p>

<pre>// Additional Public API.
...
iconv._collect = IconvLiteDecoderStream.prototype.collect;</pre>

<p>};</p>

<p>// == Encoder stream
======================================================= function
IconvLiteEncoderStream(conv, options) {</p>

<pre>this.conv = conv;
options = options || {};
options.decodeStrings = false; // We accept only strings, so we don&#39;t need to decode them.
Transform.call(this, options);</pre>

<p>}</p>

<p>IconvLiteEncoderStream.prototype = Object.create(Transform.prototype, {</p>

<pre>constructor: { value: IconvLiteEncoderStream }</pre>

<p>});</p>

<p>IconvLiteEncoderStream.prototype._transform = function(chunk, encoding,
done) {</p>
...
<p>IconvLiteEncoderStream.prototype._flush = function(done) {</p>
...
<p>IconvLiteEncoderStream.prototype.collect = function(cb) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">chunks</span> = [];
<span class="ruby-identifier">this</span>.<span class="ruby-identifier">on</span>(<span class="ruby-string">&#39;error&#39;</span>, <span class="ruby-identifier">cb</span>);
<span class="ruby-identifier">this</span>.<span class="ruby-identifier">on</span>(<span class="ruby-string">&#39;data&#39;</span>, <span class="ruby-identifier">function</span>(<span class="ruby-identifier">chunk</span>) { <span class="ruby-identifier">chunks</span>.<span class="ruby-identifier">push</span>(<span class="ruby-identifier">chunk</span>); });
<span class="ruby-identifier">this</span>.<span class="ruby-identifier">on</span>(<span class="ruby-string">&#39;end&#39;</span>, <span class="ruby-identifier">function</span>() {
    <span class="ruby-identifier">cb</span>(<span class="ruby-identifier">null</span>, <span class="ruby-constant">Buffer</span>.<span class="ruby-identifier">concat</span>(<span class="ruby-identifier">chunks</span>));
});
...
<p>// == Decoder stream
======================================================= function
IconvLiteDecoderStream(conv, options) {</p>
...
<p>IconvLiteDecoderStream.prototype = Object.create(Transform.prototype, {</p>

<pre>constructor: { value: IconvLiteDecoderStream }</pre>

<p>});</p>

<p>IconvLiteDecoderStream.prototype._transform = function(chunk, encoding,
done) {</p>

<pre>if (!Buffer.isBuffer(chunk))
...
<p>IconvLiteDecoderStream.prototype._flush = function(done) {</p>
...
<p>IconvLiteDecoderStream.prototype.collect = function(cb) {</p>

<pre class="ruby"><span class="ruby-identifier">var</span> <span class="ruby-identifier">res</span> = <span class="ruby-string">&#39;&#39;</span>;
<span class="ruby-identifier">this</span>.<span class="ruby-identifier">on</span>(<span class="ruby-string">&#39;error&#39;</span>, <span class="ruby-identifier">cb</span>);
<span class="ruby-identifier">this</span>.<span class="ruby-identifier">on</span>(<span class="ruby-string">&#39;data&#39;</span>, <span class="ruby-identifier">function</span>(<span class="ruby-identifier">chunk</span>) { <span class="ruby-identifier">res</span> <span class="ruby-operator">+=</span> <span class="ruby-identifier">chunk</span>; });
<span class="ruby-identifier">this</span>.<span class="ruby-identifier">on</span>(<span class="ruby-string">&#39;end&#39;</span>, <span class="ruby-identifier">function</span>() {
    <span class="ruby-identifier">cb</span>(<span class="ruby-identifier">null</span>, <span class="ruby-identifier">res</span>);
});
<span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>;
</pre>
