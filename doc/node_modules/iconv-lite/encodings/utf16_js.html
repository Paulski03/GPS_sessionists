...
<title>utf16.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/iconv-lite/encodings/utf16.js">

<p>“use strict”; var Buffer = require(“buffer”).Buffer;</p>

<p>// Note: UTF16-LE (or UCS2) codec is Node.js native. See
encodings/internal.js</p>

<p>// == UTF16-BE codec.
==========================================================</p>

<p>exports.utf16be = Utf16BECodec; function Utf16BECodec() { }</p>

<p>Utf16BECodec.prototype.encoder = Utf16BEEncoder;
Utf16BECodec.prototype.decoder = Utf16BEDecoder;
Utf16BECodec.prototype.bomAware = true;</p>

<p>// – Encoding</p>

<p>function Utf16BEEncoder() { }</p>

<p>Utf16BEEncoder.prototype.write = function(str) {</p>

<pre>var buf = new Buffer(str, &#39;ucs2&#39;);
...
<p>Utf16BEEncoder.prototype.end = function() { }</p>

<p>// – Decoding</p>

<p>function Utf16BEDecoder() {</p>

<pre class="ruby"><span class="ruby-identifier">this</span>.<span class="ruby-identifier">overflowByte</span> = <span class="ruby-value">-1</span>;
</pre>

<p>}</p>

<p>Utf16BEDecoder.prototype.write = function(buf) {</p>
...
return buf2.slice(0, j).toString(&#39;ucs2&#39;);</pre>

<p>}</p>

<p>Utf16BEDecoder.prototype.end = function() { }</p>

<p>// == UTF-16 codec
============================================================= // Decoder
chooses automatically from UTF-16LE and UTF-16BE using BOM and space-based
heuristic. // Defaults to UTF-16LE, as it&#39;s prevalent and default in
Node. // <a
href="http://en.wikipedia.org/wiki/UTF-16">en.wikipedia.org/wiki/UTF-16</a>
and <a
href="http://encoding.spec.whatwg.org/#utf-16le">encoding.spec.whatwg.org/#utf-16le</a>
// Decoder default can be changed: iconv.decode(buf, &#39;utf16&#39;,
{defaultEncoding: &#39;utf-16be&#39;});</p>

<p>// Encoder uses UTF-16LE and prepends BOM (which can be overridden with
addBOM: false).</p>

<p>exports.utf16 = Utf16Codec; function Utf16Codec(codecOptions, iconv) {</p>
...
<p>Utf16Codec.prototype.encoder = Utf16Encoder; Utf16Codec.prototype.decoder =
Utf16Decoder;</p>

<p>// – Encoding (pass-through)</p>

<p>function Utf16Encoder(options, codec) {</p>

<pre>options = options || {};
if (options.addBOM === undefined)
    options.addBOM = true;
this.encoder = codec.iconv.getEncoder(&#39;utf-16le&#39;, options);</pre>

<p>}</p>

<p>Utf16Encoder.prototype.write = function(str) {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">encoder</span>.<span class="ruby-identifier">write</span>(<span class="ruby-identifier">str</span>);
</pre>

<p>}</p>

<p>Utf16Encoder.prototype.end = function() {</p>

<pre class="ruby"><span class="ruby-keyword">return</span> <span class="ruby-identifier">this</span>.<span class="ruby-identifier">encoder</span>.<span class="ruby-identifier">end</span>();
</pre>
...
<p>function Utf16Decoder(options, codec) {</p>

<pre class="ruby"><span class="ruby-identifier">this</span>.<span class="ruby-identifier">decoder</span> = <span class="ruby-identifier">null</span>;
<span class="ruby-identifier">this</span>.<span class="ruby-identifier">initialBytes</span> = [];
<span class="ruby-identifier">this</span>.<span class="ruby-identifier">initialBytesLen</span> = <span class="ruby-value">0</span>;

<span class="ruby-identifier">this</span>.<span class="ruby-identifier">options</span> = <span class="ruby-identifier">options</span> <span class="ruby-operator">||</span> {};
<span class="ruby-identifier">this</span>.<span class="ruby-identifier">iconv</span> = <span class="ruby-identifier">codec</span>.<span class="ruby-identifier">iconv</span>;
</pre>

<p>}</p>

<p>Utf16Decoder.prototype.write = function(buf) {</p>
...
return this.decoder.write(buf);</pre>

<p>}</p>

<p>Utf16Decoder.prototype.end = function() {</p>
...
return this.decoder.end();</pre>

<p>}</p>

<p>function detectEncoding(buf, defaultEncoding) {</p>

<pre>var enc = defaultEncoding || &#39;utf-16le&#39;;
