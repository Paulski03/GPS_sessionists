...
<title>sbcs-codec.js - RDoc Documentation</title>
...
<main role="main" aria-label="Page node_modules/iconv-lite/encodings/sbcs-codec.js">

<p>“use strict”; var Buffer = require(“buffer”).Buffer;</p>

<p>// Single-byte codec. Needs a &#39;chars&#39; string parameter that
contains 256 or 128 chars that // correspond to encoded bytes (if 128 -
then lower half is ASCII).</p>

<p>exports._sbcs = SBCSCodec; function SBCSCodec(codecOptions, iconv) {</p>
...
this.encodeBuf = encodeBuf;</pre>

<p>}</p>

<p>SBCSCodec.prototype.encoder = SBCSEncoder; SBCSCodec.prototype.decoder =
SBCSDecoder;</p>

<p>function SBCSEncoder(options, codec) {</p>

<pre class="ruby"><span class="ruby-identifier">this</span>.<span class="ruby-identifier">encodeBuf</span> = <span class="ruby-identifier">codec</span>.<span class="ruby-identifier">encodeBuf</span>;
</pre>

<p>}</p>

<p>SBCSEncoder.prototype.write = function(str) {</p>

<pre>var buf = new Buffer(str.length);
...
<p>SBCSEncoder.prototype.end = function() { }</p>

<p>function SBCSDecoder(options, codec) {</p>

<pre class="ruby"><span class="ruby-identifier">this</span>.<span class="ruby-identifier">decodeBuf</span> = <span class="ruby-identifier">codec</span>.<span class="ruby-identifier">decodeBuf</span>;
</pre>

<p>}</p>

<p>SBCSDecoder.prototype.write = function(buf) {</p>

<pre>// Strings are immutable in JS -&gt; we use ucs2 buffer to speed up computations.
...
return newBuf.toString(&#39;ucs2&#39;);</pre>

<p>}</p>

<p>SBCSDecoder.prototype.end = function() { }</p>
</main>
